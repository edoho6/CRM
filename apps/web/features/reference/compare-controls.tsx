  ...
  return (
    <div
      ...
      className={cn(
        ...
        'no-print fixed inset-x-0 bottom-[var(--bottom-bar,0px)] z-sticky border-t border-ink-200 bg-white px-4 py-2 pb-[calc(env(safe-area-inset-bottom)+0.5rem)] shadow-lg',

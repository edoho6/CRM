...
- **"לעומת טיפולים קודמים" (`encounter-compare.tsx`):** שתי קריאות של אותם שני טיפולים, וכפתור אחד
  ביניהן — **טבלת ההשוואה** (שתי עמודות, צבע לפי מה שקרה לכל שורה) ו**"מה השתנה"** (רק מה שנוסף,
  מה שירד ואיזה מינון זז, עם +, − וחץ דו-כיווני לצד כל שורה ולא רק בכותרת). כל עמודה מדפיסה את
  המינון **שלה בלבד**: "היה 9" ליד 16 בעמודת "עכשיו" נקרא בשורה עברית כרצף אחד ויצא "היה 9 16"
  (15.9). שינוי מינון מוצג עם מילים בין שני המספרים (`doseFromTo` — "מ־9 ל־6") ולא עם חץ ביניהם,
  כי שני מספרים משני צדי סימן ניטרלי מתחלפים במקום. שם הפורמולה, הסה״כ והמינון הם `text-sm
  font-semibold` — הם הכותרת של העמודה ולא עוד שורה ברשימה; המינון המחולק קודם והמינון היומי
  אחריו בסוגריים ("3 גרם פעמיים ביום (סה״כ 6 גרם ליום)"), כי זו הצורה שבה ההוראה נאמרת

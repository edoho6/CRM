...
import { Button, Field, Input, LtrInput, Select, Spinner } from '@clinic/ui';
  ...
  return (
    <div className="relative inline-block">
      <button
        ...
        aria-label={t('editStockFor', { herb: herbName })}
        title={t('editStock')}
      ...
      {open ? (
        <div
          ...
          className="absolute z-40 mt-1 w-72 rounded-lg border border-ink-200 bg-white p-3 shadow-lg"
        >
          ...
          <div className="space-y-3">
            <div>
              ...
              <div className="mt-1.5 flex justify-end">
                <Button type="button" size="sm" variant="secondary" onClick={saveThresholds} disabled={isPending}>

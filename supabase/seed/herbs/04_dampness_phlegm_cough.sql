...
perform public.upsert_herb('Cang Zhu','苍术','Atractylodes lancea (Rhizoma)','Rhizoma Atractylodis','Black atractylodes',
...
perform public.upsert_herb('Hou Po','厚朴','Magnolia officinalis (Cortex)','Cortex Magnoliae Officinalis','Magnolia bark',
...
perform public.upsert_herb('Huo Xiang','藿香','Pogostemon cablin (Herba)','Herba Pogostemonis','Patchouli',
...
perform public.upsert_herb('Pei Lan','佩兰','Eupatorium fortunei (Herba)','Herba Eupatorii','Eupatorium',
...
perform public.upsert_herb('Sha Ren','砂仁','Amomum villosum (Fructus)','Fructus Amomi','Amomum fruit',
...
perform public.upsert_herb('Bai Dou Kou','白豆蔻','Amomum kravanh (Fructus)','Fructus Amomi Rotundus','Round cardamom',
...
perform public.upsert_herb('Cao Dou Kou','草豆蔻','Alpinia katsumadai (Semen)','Semen Alpiniae Katsumadai','Katsumada galangal seed',
...
perform public.upsert_herb('Cao Guo','草果','Amomum tsao-ko (Fructus)','Fructus Tsaoko','Tsaoko fruit',
  'aromatic_transform_dampness','warm','{acrid}','{spleen,stomach}',
...
perform public.upsert_herb('Ban Xia','半夏','Pinellia ternata (Rhizoma)','Rhizoma Pinelliae','Pinellia rhizome',
...
perform public.upsert_herb('Tian Nan Xing','天南星','Arisaema erubescens (Rhizoma)','Rhizoma Arisaematis','Jack-in-the-pulpit rhizome',
...
perform public.upsert_herb('Bai Fu Zi','白附子','Typhonium giganteum (Rhizoma)','Rhizoma Typhonii','Typhonium rhizome',
...
perform public.upsert_herb('Bai Jie Zi','白芥子','Sinapis alba (Semen)','Semen Sinapis','White mustard seed',
...
perform public.upsert_herb('Jie Geng','桔梗','Platycodon grandiflorum (Radix)','Radix Platycodonis','Balloon flower root',
...
perform public.upsert_herb('Xuan Fu Hua','旋覆花','Inula japonica (Flos)','Flos Inulae','Inula flower',
...
perform public.upsert_herb('Bai Qian','白前','Cynanchum stauntonii (Rhizoma)','Rhizoma Cynanchi Stauntonii','Cynanchum rhizome',
...
perform public.upsert_herb('Zao Jiao Ci','皂角刺','Gleditsia sinensis (Spina)','Spina Gleditsiae','Honey locust thorn',
...
perform public.upsert_herb('Chuan Bei Mu','川贝母','Fritillaria cirrhosa (Bulbus)','Bulbus Fritillariae Cirrhosae','Sichuan fritillary bulb',
...
perform public.upsert_herb('Zhe Bei Mu','浙贝母','Fritillaria thunbergii (Bulbus)','Bulbus Fritillariae Thunbergii','Zhejiang fritillary bulb',
...
perform public.upsert_herb('Gua Lou','瓜蒌','Trichosanthes kirilowii (Fructus)','Fructus Trichosanthis','Trichosanthes fruit',
...
perform public.upsert_herb('Zhu Ru','竹茹','Bambusa tuldoides (Caulis in taeniis)','Caulis Bambusae in Taenia','Bamboo shavings',
...
perform public.upsert_herb('Tian Zhu Huang','天竺黄','Bambusa textilis (Concretio silicea)','Concretio Silicea Bambusae','Tabasheer, bamboo silica',
...
perform public.upsert_herb('Zhu Li','竹沥','Bambusa (Succus)','Succus Bambusae','Bamboo sap',
...
perform public.upsert_herb('Qian Hu','前胡','Peucedanum praeruptorum (Radix)','Radix Peucedani','Peucedanum root',
...
perform public.upsert_herb('Kun Bu','昆布','Laminaria japonica (Thallus)','Thallus Laminariae','Kelp',
...
perform public.upsert_herb('Hai Zao','海藻','Sargassum pallidum (Thallus)','Sargassum','Sargassum seaweed',
...
perform public.upsert_herb('Hai Ge Ke','海蛤壳','Meretrix meretrix or Cyclina sinensis (Concha)','Concha Meretricis seu Cyclinae','Clam shell',
...
perform public.upsert_herb('Pang Da Hai','胖大海','Sterculia lychnophora (Semen)','Semen Sterculiae Lychnophorae','Sterculia seed, boat sterculia',
...
perform public.upsert_herb('Fu Hai Shi','浮海石','Pumex (mineral)','Pumex','Pumice',
...
perform public.upsert_herb('Meng Shi','礞石','Chlorite schist (mineral)','Lapis Chloriti','Chlorite schist',
...
perform public.upsert_herb('Xing Ren','杏仁','Prunus armeniaca (Semen amarum)','Semen Armeniacae Amarum','Bitter apricot kernel',
...
perform public.upsert_herb('Zi Su Zi','紫苏子','Perilla frutescens (Fructus)','Fructus Perillae','Perilla seed',
...
perform public.upsert_herb('Bai Bu','百部','Stemona sessilifolia (Radix)','Radix Stemonae','Stemona root',
...
perform public.upsert_herb('Zi Wan','紫菀','Aster tataricus (Radix)','Radix Asteris','Aster root',
...
perform public.upsert_herb('Kuan Dong Hua','款冬花','Tussilago farfara (Flos)','Flos Farfarae','Coltsfoot flower',
...
perform public.upsert_herb('Pi Pa Ye','枇杷叶','Eriobotrya japonica (Folium)','Folium Eriobotryae','Loquat leaf',
...
perform public.upsert_herb('Sang Bai Pi','桑白皮','Morus alba (Cortex radicis)','Cortex Mori','Mulberry root bark',
...
perform public.upsert_herb('Ting Li Zi','葶苈子','Descurainia sophia or Lepidium apetalum (Semen)','Semen Descurainiae seu Lepidii','Descurainia seed',
...
perform public.upsert_herb('Bai Guo','白果','Ginkgo biloba (Semen)','Semen Ginkgo','Ginkgo nut',
...
perform public.upsert_herb('Luo Han Guo','罗汉果','Siraitia grosvenorii (Fructus)','Fructus Siraitiae','Monk fruit',

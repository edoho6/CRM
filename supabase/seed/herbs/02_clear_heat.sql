...
perform public.upsert_herb('Shi Gao','石膏','Gypsum fibrosum (mineral, CaSO4·2H2O)','Gypsum Fibrosum','Gypsum',
...
perform public.upsert_herb('Zhi Mu','知母','Anemarrhena asphodeloides (Rhizoma)','Rhizoma Anemarrhenae','Anemarrhena rhizome',
...
perform public.upsert_herb('Zhi Zi','栀子','Gardenia jasminoides (Fructus)','Fructus Gardeniae','Gardenia fruit',
...
perform public.upsert_herb('Xia Ku Cao','夏枯草','Prunella vulgaris (Spica)','Spica Prunellae','Self-heal spike',
...
perform public.upsert_herb('Dan Zhu Ye','淡竹叶','Lophatherum gracile (Herba)','Herba Lophatheri','Lophatherum',
...
perform public.upsert_herb('Lu Gen','芦根','Phragmites communis (Rhizoma)','Rhizoma Phragmitis','Reed rhizome',
...
perform public.upsert_herb('Tian Hua Fen','天花粉','Trichosanthes kirilowii (Radix)','Radix Trichosanthis','Trichosanthes root',
...
perform public.upsert_herb('Jue Ming Zi','决明子','Cassia obtusifolia (Semen)','Semen Cassiae','Cassia seed',
...
perform public.upsert_herb('Han Shui Shi','寒水石','Glauberite or calcite (mineral)','Glauberitum','Glauberite',
...
perform public.upsert_herb('Mi Meng Hua','密蒙花','Buddleja officinalis (Flos)','Flos Buddlejae','Buddleja flower bud',
...
perform public.upsert_herb('Qing Xiang Zi','青葙子','Celosia argentea (Semen)','Semen Celosiae','Celosia seed',
...
perform public.upsert_herb('Gu Jing Cao','谷精草','Eriocaulon buergerianum (Flos)','Flos Eriocauli','Pipewort flower',
...
perform public.upsert_herb('Sheng Di Huang','生地黄','Rehmannia glutinosa (Radix)','Radix Rehmanniae','Raw rehmannia root',
...
perform public.upsert_herb('Xuan Shen','玄参','Scrophularia ningpoensis (Radix)','Radix Scrophulariae','Scrophularia root',
...
perform public.upsert_herb('Mu Dan Pi','牡丹皮','Paeonia suffruticosa (Cortex)','Cortex Moutan','Moutan bark',
...
perform public.upsert_herb('Chi Shao','赤芍','Paeonia veitchii (Radix)','Radix Paeoniae Rubra','Red peony root',
...
perform public.upsert_herb('Zi Cao','紫草','Arnebia euchroma (Radix)','Radix Arnebiae','Arnebia, gromwell root',
...
perform public.upsert_herb('Shui Niu Jiao','水牛角','Bubalus bubalis (Cornu)','Cornu Bubali','Water buffalo horn',
...
perform public.upsert_herb('Huang Qin','黄芩','Scutellaria baicalensis (Radix)','Radix Scutellariae','Baikal skullcap root',
...
perform public.upsert_herb('Huang Lian','黄连','Coptis chinensis (Rhizoma)','Rhizoma Coptidis','Coptis rhizome',
...
perform public.upsert_herb('Huang Bai','黄柏','Phellodendron chinense (Cortex)','Cortex Phellodendri','Phellodendron bark',
...
perform public.upsert_herb('Long Dan Cao','龙胆草','Gentiana scabra (Radix)','Radix Gentianae','Chinese gentian root',
...
perform public.upsert_herb('Ku Shen','苦参','Sophora flavescens (Radix)','Radix Sophorae Flavescentis','Sophora root',
...
perform public.upsert_herb('Qin Pi','秦皮','Fraxinus rhynchophylla (Cortex)','Cortex Fraxini','Ash bark',
...
perform public.upsert_herb('Bai Xian Pi','白鲜皮','Dictamnus dasycarpus (Cortex)','Cortex Dictamni','Dittany root bark',
...
perform public.upsert_herb('Jin Yin Hua','金银花','Lonicera japonica (Flos)','Flos Lonicerae','Honeysuckle flower',
...
perform public.upsert_herb('Lian Qiao','连翘','Forsythia suspensa (Fructus)','Fructus Forsythiae','Forsythia fruit',
...
perform public.upsert_herb('Pu Gong Ying','蒲公英','Taraxacum mongolicum (Herba)','Herba Taraxaci','Dandelion',
...
perform public.upsert_herb('Zi Hua Di Ding','紫花地丁','Viola yedoensis (Herba)','Herba Violae','Chinese violet',
...
perform public.upsert_herb('Ye Ju Hua','野菊花','Chrysanthemum indicum (Flos)','Flos Chrysanthemi Indici','Wild chrysanthemum',
...
perform public.upsert_herb('Da Qing Ye','大青叶','Isatis indigotica (Folium)','Folium Isatidis','Isatis leaf',
...
perform public.upsert_herb('Ban Lan Gen','板蓝根','Isatis indigotica (Radix)','Radix Isatidis','Isatis root',
...
perform public.upsert_herb('Qing Dai','青黛','Indigo naturalis (from Isatis or Baphicacanthus)','Indigo Naturalis','Natural indigo',
...
perform public.upsert_herb('Yu Xing Cao','鱼腥草','Houttuynia cordata (Herba)','Herba Houttuyniae','Houttuynia',
...
perform public.upsert_herb('Bai Hua She She Cao','白花蛇舌草','Hedyotis diffusa (Herba)','Herba Hedyotidis','Oldenlandia',
...
perform public.upsert_herb('Chuan Xin Lian','穿心莲','Andrographis paniculata (Herba)','Herba Andrographis','Andrographis',
...
perform public.upsert_herb('She Gan','射干','Belamcanda chinensis (Rhizoma)','Rhizoma Belamcandae','Blackberry lily rhizome',
...
perform public.upsert_herb('Shan Dou Gen','山豆根','Sophora tonkinensis (Radix)','Radix Sophorae Tonkinensis','Sophora subprostrata root',
...
perform public.upsert_herb('Ma Bo','马勃','Lasiosphaera fenzlii or Calvatia (Fructificatio)','Lasiosphaera seu Calvatia','Puffball',
...
perform public.upsert_herb('Bai Tou Weng','白头翁','Pulsatilla chinensis (Radix)','Radix Pulsatillae','Pulsatilla root',
...
perform public.upsert_herb('Ma Chi Xian','马齿苋','Portulaca oleracea (Herba)','Herba Portulacae','Purslane',
...
perform public.upsert_herb('Tu Fu Ling','土茯苓','Smilax glabra (Rhizoma)','Rhizoma Smilacis Glabrae','Smilax, glabrous greenbrier',
...
perform public.upsert_herb('Bai Jiang Cao','败酱草','Patrinia scabiosifolia (Herba)','Herba Patriniae','Patrinia',
...
perform public.upsert_herb('Ban Bian Lian','半边莲','Lobelia chinensis (Herba)','Herba Lobeliae Chinensis','Chinese lobelia',
...
perform public.upsert_herb('Shan Ci Gu','山慈菇','Cremastra appendiculata (Pseudobulbus)','Pseudobulbus Cremastrae','Cremastra pseudobulb',
...
perform public.upsert_herb('Ya Dan Zi','鸦胆子','Brucea javanica (Fructus)','Fructus Bruceae','Brucea fruit',
...
perform public.upsert_herb('Chong Lou','重楼','Paris polyphylla (Rhizoma)','Rhizoma Paridis','Paris rhizome',
...
perform public.upsert_herb('Lu Dou','绿豆','Vigna radiata (Semen)','Semen Phaseoli Radiati','Mung bean',
...
perform public.upsert_herb('Qing Hao','青蒿','Artemisia annua (Herba)','Herba Artemisiae Annuae','Sweet wormwood',
...
perform public.upsert_herb('Di Gu Pi','地骨皮','Lycium chinense (Cortex radicis)','Cortex Lycii','Lycium root bark',
...
perform public.upsert_herb('Yin Chai Hu','银柴胡','Stellaria dichotoma (Radix)','Radix Stellariae','Stellaria root',
...
perform public.upsert_herb('Hu Huang Lian','胡黄连','Picrorhiza scrophulariiflora (Rhizoma)','Rhizoma Picrorhizae','Picrorhiza rhizome',
...
perform public.upsert_herb('Bai Wei','白薇','Cynanchum atratum (Radix)','Radix Cynanchi Atrati','Cynanchum, blackend swallowwort root',
...
perform public.upsert_herb('He Ye','荷叶','Nelumbo nucifera (Folium)','Folium Nelumbinis','Lotus leaf',
...
perform public.upsert_herb('Xi Gua Pi','西瓜皮','Citrullus lanatus (Exocarpium)','Exocarpium Citrulli','Watermelon rind',
...
perform public.upsert_herb('Bai Bian Dou','白扁豆','Lablab purpureus (Semen)','Semen Lablab Album','Hyacinth bean',

...
perform public.upsert_herb('Da Huang','大黄','Rheum palmatum (Radix et Rhizoma)','Radix et Rhizoma Rhei','Chinese rhubarb root',
...
perform public.upsert_herb('Mang Xiao','芒硝','Natrii sulfas (mineral)','Natrii Sulfas','Mirabilite, sodium sulfate',
...
perform public.upsert_herb('Fan Xie Ye','番泻叶','Senna alexandrina (Folium)','Folium Sennae','Senna leaf',
...
perform public.upsert_herb('Lu Hui','芦荟','Aloe vera or A. ferox (concentrated juice)','Aloe','Aloe',
...
perform public.upsert_herb('Huo Ma Ren','火麻仁','Cannabis sativa (Semen, heat-treated)','Semen Cannabis','Hemp seed',
...
perform public.upsert_herb('Yu Li Ren','郁李仁','Prunus japonica (Semen)','Semen Pruni','Bush cherry pit',
...
perform public.upsert_herb('Song Zi Ren','松子仁','Pinus koraiensis (Semen)','Semen Pini Koraiensis','Pine nut',
...
perform public.upsert_herb('Gan Sui','甘遂','Euphorbia kansui (Radix)','Radix Kansui','Kansui root',
...
perform public.upsert_herb('Jing Da Ji','京大戟','Euphorbia pekinensis (Radix)','Radix Euphorbiae Pekinensis','Peking spurge root',
...
perform public.upsert_herb('Yuan Hua','芫花','Daphne genkwa (Flos)','Flos Genkwa','Genkwa flower',
...
perform public.upsert_herb('Qian Niu Zi','牵牛子','Pharbitis nil (Semen)','Semen Pharbitidis','Morning glory seed',
  'harsh_expellant','cold','{bitter,acrid}','{lung,kidney,large_intestine}',
...
perform public.upsert_herb('Ba Dou','巴豆','Croton tiglium (Fructus, defatted)','Fructus Crotonis Pulveratus','Croton seed',
...
perform public.upsert_herb('Shang Lu','商陆','Phytolacca acinosa (Radix)','Radix Phytolaccae','Pokeweed root',
...
perform public.upsert_herb('Fu Ling','茯苓','Poria cocos (Sclerotium)','Poria','Poria, hoelen',
...
perform public.upsert_herb('Zhu Ling','猪苓','Polyporus umbellatus (Sclerotium)','Polyporus','Polyporus',
...
perform public.upsert_herb('Ze Xie','泽泻','Alisma orientale (Rhizoma)','Rhizoma Alismatis','Water plantain rhizome',
...
perform public.upsert_herb('Yi Yi Ren','薏苡仁','Coix lacryma-jobi (Semen)','Semen Coicis','Job''s tears, coix seed',
...
perform public.upsert_herb('Che Qian Zi','车前子','Plantago asiatica (Semen)','Semen Plantaginis','Plantain seed',
...
perform public.upsert_herb('Hua Shi','滑石','Talcum (mineral, hydrated magnesium silicate)','Talcum','Talc',
...
perform public.upsert_herb('Mu Tong','木通','Akebia quinata or A. trifoliata (Caulis)','Caulis Akebiae','Akebia stem',
...
perform public.upsert_herb('Tong Cao','通草','Tetrapanax papyrifer (Medulla)','Medulla Tetrapanacis','Rice paper plant pith',
...
perform public.upsert_herb('Bian Xu','萹蓄','Polygonum aviculare (Herba)','Herba Polygoni Avicularis','Knotweed',
...
perform public.upsert_herb('Qu Mai','瞿麦','Dianthus superbus (Herba)','Herba Dianthi','Fringed pink',
  'drain_dampness','cold','{bitter}','{heart,small_intestine,bladder}',
...
perform public.upsert_herb('Di Fu Zi','地肤子','Kochia scoparia (Fructus)','Fructus Kochiae','Kochia fruit',
...
perform public.upsert_herb('Hai Jin Sha','海金沙','Lygodium japonicum (Spora)','Spora Lygodii','Lygodium spores',
...
perform public.upsert_herb('Shi Wei','石韦','Pyrrosia lingua (Folium)','Folium Pyrrosiae','Pyrrosia leaf',
...
perform public.upsert_herb('Jin Qian Cao','金钱草','Lysimachia christinae (Herba)','Herba Lysimachiae','Lysimachia, coin grass',
...
perform public.upsert_herb('Yin Chen Hao','茵陈蒿','Artemisia scoparia or A. capillaris (Herba)','Herba Artemisiae Scopariae','Capillaris, virgate wormwood',
...
perform public.upsert_herb('Dong Gua Pi','冬瓜皮','Benincasa hispida (Exocarpium)','Exocarpium Benincasae','Winter melon peel',
...
perform public.upsert_herb('Chi Xiao Dou','赤小豆','Vigna umbellata (Semen)','Semen Phaseoli','Rice bean, adzuki',
...
perform public.upsert_herb('Bi Xie','萆薢','Dioscorea hypoglauca (Rhizoma)','Rhizoma Dioscoreae Hypoglaucae','Fish poison yam',
...
perform public.upsert_herb('Deng Xin Cao','灯心草','Juncus effusus (Medulla)','Medulla Junci','Rush pith',
...
perform public.upsert_herb('Du Huo','独活','Angelica pubescens (Radix)','Radix Angelicae Pubescentis','Pubescent angelica root',
...
perform public.upsert_herb('Wei Ling Xian','威灵仙','Clematis chinensis (Radix)','Radix Clematidis','Clematis root',
...
perform public.upsert_herb('Qin Jiao','秦艽','Gentiana macrophylla (Radix)','Radix Gentianae Macrophyllae','Large-leaf gentian root',
...
perform public.upsert_herb('Sang Zhi','桑枝','Morus alba (Ramulus)','Ramulus Mori','Mulberry twig',
...
perform public.upsert_herb('Mu Gua','木瓜','Chaenomeles speciosa (Fructus)','Fructus Chaenomelis','Chinese quince',
...
perform public.upsert_herb('Hai Tong Pi','海桐皮','Erythrina variegata (Cortex)','Cortex Erythrinae','Erythrina bark',
...
perform public.upsert_herb('Xi Xian Cao','豨莶草','Siegesbeckia orientalis (Herba)','Herba Siegesbeckiae','Siegesbeckia',
...
perform public.upsert_herb('Chou Wu Tong','臭梧桐','Clerodendrum trichotomum (Folium)','Folium Clerodendri','Harlequin glorybower leaf',
...
perform public.upsert_herb('Luo Shi Teng','络石藤','Trachelospermum jasminoides (Caulis)','Caulis Trachelospermi','Star jasmine stem',
...
perform public.upsert_herb('Sang Ji Sheng','桑寄生','Taxillus chinensis (Herba)','Herba Taxilli','Mulberry mistletoe',
...
perform public.upsert_herb('Wu Jia Pi','五加皮','Acanthopanax gracilistylus (Cortex radicis)','Cortex Acanthopanacis','Acanthopanax root bark',
...
perform public.upsert_herb('Shen Jin Cao','伸筋草','Lycopodium japonicum (Herba)','Herba Lycopodii','Club moss',
...
perform public.upsert_herb('Qian Nian Jian','千年健','Homalomena occulta (Rhizoma)','Rhizoma Homalomenae','Homalomena rhizome',
  'dispel_wind_dampness','warm','{acrid,bitter}','{liver,kidney}',
...
perform public.upsert_herb('Hai Feng Teng','海风藤','Piper kadsura (Caulis)','Caulis Piperis Kadsurae','Kadsura pepper stem',
...
perform public.upsert_herb('Wu Shao She','乌梢蛇','Zaocys dhumnades (whole body)','Zaocys','Black-striped snake',
...
perform public.upsert_herb('Qi She','蕲蛇','Agkistrodon acutus (whole body)','Agkistrodon','Long-nosed pit viper',
...
perform public.upsert_herb('Han Fang Ji','汉防己','Stephania tetrandra (Radix)','Radix Stephaniae Tetrandrae','Stephania root',

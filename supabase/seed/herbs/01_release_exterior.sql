...
-- ============================================================================
-- Loaded through public.upsert_herb (see migration 20260906093000). Every row
...
perform public.upsert_herb('Ma Huang','麻黄','Ephedra sinica (Herba)','Herba Ephedrae','Ephedra',
...
perform public.upsert_herb('Gui Zhi','桂枝','Cinnamomum cassia (Ramulus)','Ramulus Cinnamomi','Cinnamon twig',
...
perform public.upsert_herb('Zi Su Ye','紫苏叶','Perilla frutescens (Folium)','Folium Perillae','Perilla leaf',
...
perform public.upsert_herb('Jing Jie','荆芥','Schizonepeta tenuifolia (Herba)','Herba Schizonepetae','Schizonepeta',
...
perform public.upsert_herb('Fang Feng','防风','Saposhnikovia divaricata (Radix)','Radix Saposhnikoviae','Siler root',
...
perform public.upsert_herb('Qiang Huo','羌活','Notopterygium incisum (Rhizoma et Radix)','Rhizoma et Radix Notopterygii','Notopterygium',
...
perform public.upsert_herb('Gao Ben','藁本','Ligusticum sinense (Rhizoma)','Rhizoma Ligustici','Chinese lovage root',
...
perform public.upsert_herb('Bai Zhi','白芷','Angelica dahurica (Radix)','Radix Angelicae Dahuricae','Dahurian angelica root',
...
perform public.upsert_herb('Xi Xin','细辛','Asarum heterotropoides (Herba cum Radice)','Herba Asari','Asarum, wild ginger',
...
perform public.upsert_herb('Sheng Jiang','生姜','Zingiber officinale (Rhizoma recens)','Rhizoma Zingiberis Recens','Fresh ginger',
...
perform public.upsert_herb('Cong Bai','葱白','Allium fistulosum (Bulbus)','Bulbus Allii Fistulosi','Scallion white',
  'release_exterior_warm','warm','{acrid}','{lung,stomach}',
...
perform public.upsert_herb('Xiang Ru','香薷','Mosla chinensis (Herba)','Herba Moslae','Mosla, aromatic madder',
...
perform public.upsert_herb('Cang Er Zi','苍耳子','Xanthium sibiricum (Fructus)','Fructus Xanthii','Cocklebur fruit',
...
perform public.upsert_herb('Xin Yi Hua','辛夷','Magnolia biondii (Flos)','Flos Magnoliae','Magnolia flower bud',
  'release_exterior_warm','warm','{acrid}','{lung,stomach}',
...
perform public.upsert_herb('Hu Sui','胡荽','Coriandrum sativum (Herba)','Herba Coriandri','Coriander',
  'release_exterior_warm','warm','{acrid}','{lung,stomach}',
...
perform public.upsert_herb('Bo He','薄荷','Mentha haplocalyx (Herba)','Herba Menthae','Field mint',
...
perform public.upsert_herb('Niu Bang Zi','牛蒡子','Arctium lappa (Fructus)','Fructus Arctii','Burdock fruit',
...
perform public.upsert_herb('Chan Tui','蝉蜕','Cryptotympana pustulata (Periostracum)','Periostracum Cicadae','Cicada moulting',
...
perform public.upsert_herb('Sang Ye','桑叶','Morus alba (Folium)','Folium Mori','Mulberry leaf',
...
perform public.upsert_herb('Ju Hua','菊花','Chrysanthemum morifolium (Flos)','Flos Chrysanthemi','Chrysanthemum flower',
...
perform public.upsert_herb('Man Jing Zi','蔓荆子','Vitex trifolia (Fructus)','Fructus Viticis','Vitex fruit',
...
perform public.upsert_herb('Chai Hu','柴胡','Bupleurum chinense (Radix)','Radix Bupleuri','Bupleurum root',
...
perform public.upsert_herb('Sheng Ma','升麻','Cimicifuga foetida (Rhizoma)','Rhizoma Cimicifugae','Black cohosh rhizome (Chinese)',
...
perform public.upsert_herb('Ge Gen','葛根','Pueraria lobata (Radix)','Radix Puerariae','Kudzu root',
...
perform public.upsert_herb('Dan Dou Chi','淡豆豉','Glycine max (Semen praeparatum)','Semen Sojae Praeparatum','Prepared soybean',
...
perform public.upsert_herb('Fu Ping','浮萍','Spirodela polyrrhiza (Herba)','Herba Spirodelae','Duckweed',
...
perform public.upsert_herb('Mu Zei','木贼','Equisetum hiemale (Herba)','Herba Equiseti Hiemalis','Scouring rush, horsetail',

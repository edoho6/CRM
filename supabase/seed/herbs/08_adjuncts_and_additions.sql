...
perform public.upsert_herb('Jing Mi','粳米','Oryza sativa (Semen)','Semen Oryzae','Non-glutinous rice',
...
perform public.upsert_herb('Ji Zi Huang','鸡子黄','Gallus gallus domesticus (Vitellus)','Vitellus Ovi Galli','Egg yolk',
...
perform public.upsert_herb('Bai Jiu','白酒','Fermented grain wine','Vinum','Clear rice wine',
...
perform public.upsert_herb('Li Pi','梨皮','Pyrus (Pericarpium)','Pericarpium Pyri','Pear peel',
...
perform public.upsert_herb('Lian Xu','莲须','Nelumbo nucifera (Stamen)','Stamen Nelumbinis','Lotus stamen',
...
perform public.upsert_herb('Wu Bei Zi','五倍子','Rhus chinensis (Galla)','Galla Chinensis','Chinese gallnut',
...
perform public.upsert_herb('Zao Xin Tu','灶心土','Earth from the centre of a wood-fired stove','Terra Flava Usta','Stove earth, yellow earth',
...
perform public.upsert_herb('Zi Bei Tian Kui','紫背天葵','Semiaquilegia adoxoides (Radix)','Radix Semiaquilegiae','Semiaquilegia root',
...
perform public.upsert_herb('Chuan Niu Xi','川牛膝','Cyathula officinalis (Radix)','Radix Cyathulae','Cyathula root',
...
perform public.upsert_herb('Ban Zhi Lian','半枝莲','Scutellaria barbata (Herba)','Herba Scutellariae Barbatae','Barbat skullcap',
...
perform public.upsert_herb('Wa Leng Zi','瓦楞子','Arca (Concha)','Concha Arcae','Ark shell, cockle shell',
...
perform public.upsert_herb('Zi Su Geng','紫苏梗','Perilla frutescens (Caulis)','Caulis Perillae','Perilla stem',
...
perform public.upsert_herb('Lu Lu Tong','路路通','Liquidambar formosana (Fructus)','Fructus Liquidambaris','Sweetgum fruit',

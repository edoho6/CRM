...
perform public.catalogue_upsert_herb('Shan Zha','山楂','Crataegus pinnatifida (Fructus)','Fructus Crataegi','Chinese hawthorn fruit',
...
perform public.catalogue_upsert_herb('Shen Qu','神曲','Massa medicata fermentata (fermented mixture)','Massa Medicata Fermentata','Medicated leaven',
...
perform public.catalogue_upsert_herb('Mai Ya','麦芽','Hordeum vulgare (Fructus germinatus)','Fructus Hordei Germinatus','Barley sprout',
...
perform public.catalogue_upsert_herb('Gu Ya','谷芽','Setaria italica or Oryza sativa (Fructus germinatus)','Fructus Setariae Germinatus','Millet or rice sprout',
...
perform public.catalogue_upsert_herb('Lai Fu Zi','莱菔子','Raphanus sativus (Semen)','Semen Raphani','Radish seed',
...
perform public.catalogue_upsert_herb('Ji Nei Jin','鸡内金','Gallus gallus domesticus (Endothelium corneum gigeriae)','Endothelium Corneum Gigeriae Galli','Chicken gizzard lining',
...
perform public.catalogue_upsert_herb('Chen Pi','陈皮','Citrus reticulata (Pericarpium)','Pericarpium Citri Reticulatae','Aged tangerine peel',
...
perform public.catalogue_upsert_herb('Qing Pi','青皮','Citrus reticulata (Pericarpium viride)','Pericarpium Citri Reticulatae Viride','Green tangerine peel',
...
perform public.catalogue_upsert_herb('Zhi Shi','枳实','Citrus aurantium (Fructus immaturus)','Fructus Aurantii Immaturus','Immature bitter orange',
...
perform public.catalogue_upsert_herb('Zhi Ke','枳壳','Citrus aurantium (Fructus)','Fructus Aurantii','Bitter orange',
...
perform public.catalogue_upsert_herb('Mu Xiang','木香','Aucklandia lappa (Radix)','Radix Aucklandiae','Costus root',
...
perform public.catalogue_upsert_herb('Xiang Fu','香附','Cyperus rotundus (Rhizoma)','Rhizoma Cyperi','Nutgrass rhizome',
...
perform public.catalogue_upsert_herb('Wu Yao','乌药','Lindera aggregata (Radix)','Radix Linderae','Lindera root',
...
perform public.catalogue_upsert_herb('Chuan Lian Zi','川楝子','Melia toosendan (Fructus)','Fructus Toosendan','Sichuan chinaberry fruit',
...
perform public.catalogue_upsert_herb('Xie Bai','薤白','Allium macrostemon (Bulbus)','Bulbus Allii Macrostemi','Chinese chive bulb',
...
perform public.catalogue_upsert_herb('Tan Xiang','檀香','Santalum album (Lignum)','Lignum Santali Albi','Sandalwood',
...
perform public.catalogue_upsert_herb('Chen Xiang','沉香','Aquilaria sinensis (Lignum resinatum)','Lignum Aquilariae Resinatum','Agarwood, aloeswood',
...
perform public.catalogue_upsert_herb('Fo Shou','佛手','Citrus medica var. sarcodactylis (Fructus)','Fructus Citri Sarcodactylis','Buddha''s hand citron',
...
perform public.catalogue_upsert_herb('Xiang Yuan','香橼','Citrus medica or C. wilsonii (Fructus)','Fructus Citri','Citron fruit',
...
perform public.catalogue_upsert_herb('Da Fu Pi','大腹皮','Areca catechu (Pericarpium)','Pericarpium Arecae','Betel husk',
...
perform public.catalogue_upsert_herb('Shi Di','柿蒂','Diospyros kaki (Calyx)','Calyx Kaki','Persimmon calyx',
...
perform public.catalogue_upsert_herb('Mei Gui Hua','玫瑰花','Rosa rugosa (Flos)','Flos Rosae Rugosae','Rose bud',
...
perform public.catalogue_upsert_herb('Li Zhi He','荔枝核','Litchi chinensis (Semen)','Semen Litchi','Lychee seed',
...
perform public.catalogue_upsert_herb('San Qi','三七','Panax notoginseng (Radix)','Radix Notoginseng','Notoginseng, tienchi',
...
perform public.catalogue_upsert_herb('Bai Ji','白及','Bletilla striata (Rhizoma)','Rhizoma Bletillae','Bletilla rhizome',
...
perform public.catalogue_upsert_herb('Xian He Cao','仙鹤草','Agrimonia pilosa (Herba)','Herba Agrimoniae','Agrimony',
...
perform public.catalogue_upsert_herb('Di Yu','地榆','Sanguisorba officinalis (Radix)','Radix Sanguisorbae','Burnet root',
...
perform public.catalogue_upsert_herb('Huai Hua','槐花','Styphnolobium japonicum (Flos)','Flos Sophorae','Pagoda tree flower',
...
perform public.catalogue_upsert_herb('Ce Bai Ye','侧柏叶','Platycladus orientalis (Cacumen)','Cacumen Platycladi','Arborvitae twig',
...
perform public.catalogue_upsert_herb('Da Ji','大蓟','Cirsium japonicum (Herba)','Herba Cirsii Japonici','Japanese thistle',
...
perform public.catalogue_upsert_herb('Xiao Ji','小蓟','Cirsium setosum (Herba)','Herba Cirsii','Field thistle',
  'stop_bleeding','cool','{sweet,bitter}','{heart,liver}',
...
perform public.catalogue_upsert_herb('Bai Mao Gen','白茅根','Imperata cylindrica (Rhizoma)','Rhizoma Imperatae','Cogongrass rhizome',
...
perform public.catalogue_upsert_herb('Ou Jie','藕节','Nelumbo nucifera (Nodus rhizomatis)','Nodus Nelumbinis Rhizomatis','Lotus rhizome node',
...
perform public.catalogue_upsert_herb('Pu Huang','蒲黄','Typha angustifolia (Pollen)','Pollen Typhae','Cattail pollen',
...
perform public.catalogue_upsert_herb('Ai Ye','艾叶','Artemisia argyi (Folium)','Folium Artemisiae Argyi','Mugwort leaf',
...
perform public.catalogue_upsert_herb('Zong Lu Tan','棕榈炭','Trachycarpus fortunei (Petiolus carbonisatus)','Petiolus Trachycarpi Carbonisatus','Charred palm fiber',
...
perform public.catalogue_upsert_herb('Xue Yu Tan','血余炭','Crinis carbonisatus (charred human hair)','Crinis Carbonisatus','Charred hair',
...
perform public.catalogue_upsert_herb('Qian Cao','茜草','Rubia cordifolia (Radix)','Radix Rubiae','Madder root',
...
perform public.catalogue_upsert_herb('Chuan Xiong','川芎','Ligusticum chuanxiong (Rhizoma)','Rhizoma Chuanxiong','Sichuan lovage rhizome',
...
perform public.catalogue_upsert_herb('Dan Shen','丹参','Salvia miltiorrhiza (Radix)','Radix Salviae Miltiorrhizae','Red sage root',
...
perform public.catalogue_upsert_herb('Yan Hu Suo','延胡索','Corydalis yanhusuo (Rhizoma)','Rhizoma Corydalis','Corydalis rhizome',
...
perform public.catalogue_upsert_herb('Yu Jin','郁金','Curcuma wenyujin or C. longa (Radix)','Radix Curcumae','Curcuma tuber',
...
perform public.catalogue_upsert_herb('Jiang Huang','姜黄','Curcuma longa (Rhizoma)','Rhizoma Curcumae Longae','Turmeric rhizome',
...
perform public.catalogue_upsert_herb('E Zhu','莪术','Curcuma phaeocaulis (Rhizoma)','Rhizoma Curcumae','Zedoary rhizome',
...
perform public.catalogue_upsert_herb('San Leng','三棱','Sparganium stoloniferum (Rhizoma)','Rhizoma Sparganii','Bur-reed rhizome',
...
perform public.catalogue_upsert_herb('Ru Xiang','乳香','Boswellia carterii (Gummi olibanum)','Olibanum','Frankincense',
  'invigorate_blood','warm','{acrid,bitter}','{heart,liver,spleen}',
...
perform public.catalogue_upsert_herb('Mo Yao','没药','Commiphora myrrha (Gummi resina)','Myrrha','Myrrh',
...
perform public.catalogue_upsert_herb('Wu Ling Zhi','五灵脂','Trogopterus xanthipes (Faeces)','Faeces Trogopterori','Flying squirrel droppings',
...
perform public.catalogue_upsert_herb('Tao Ren','桃仁','Prunus persica (Semen)','Semen Persicae','Peach kernel',
...
perform public.catalogue_upsert_herb('Hong Hua','红花','Carthamus tinctorius (Flos)','Flos Carthami','Safflower',
...
perform public.catalogue_upsert_herb('Yi Mu Cao','益母草','Leonurus japonicus (Herba)','Herba Leonuri','Chinese motherwort',
...
perform public.catalogue_upsert_herb('Ze Lan','泽兰','Lycopus lucidus (Herba)','Herba Lycopi','Bugleweed',
...
perform public.catalogue_upsert_herb('Niu Xi','牛膝','Achyranthes bidentata (Radix)','Radix Achyranthis Bidentatae','Achyranthes root',
...
perform public.catalogue_upsert_herb('Ji Xue Teng','鸡血藤','Spatholobus suberectus (Caulis)','Caulis Spatholobi','Spatholobus stem',
...
perform public.catalogue_upsert_herb('Wang Bu Liu Xing','王不留行','Vaccaria segetalis (Semen)','Semen Vaccariae','Vaccaria seed',
...
perform public.catalogue_upsert_herb('Su Mu','苏木','Caesalpinia sappan (Lignum)','Lignum Sappan','Sappan wood',
...
perform public.catalogue_upsert_herb('Shui Zhi','水蛭','Whitmania pigra or Hirudo nipponica (whole body)','Hirudo','Leech',
...
perform public.catalogue_upsert_herb('Tu Bie Chong','土鳖虫','Eupolyphaga sinensis (whole body)','Eupolyphaga','Wingless cockroach',
...
perform public.catalogue_upsert_herb('Yue Ji Hua','月季花','Rosa chinensis (Flos)','Flos Rosae Chinensis','China rose flower',
...
perform public.catalogue_upsert_herb('Liu Ji Nu','刘寄奴','Artemisia anomala (Herba)','Herba Artemisiae Anomalae','Anomalous artemisia',
...
perform public.catalogue_upsert_herb('Zi Ran Tong','自然铜','Pyritum (mineral, FeS2)','Pyritum','Pyrite',

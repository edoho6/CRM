...
perform public.upsert_herb('Fu Zi','附子','Aconitum carmichaelii (Radix lateralis praeparata)','Radix Aconiti Lateralis Praeparata','Prepared aconite',
...
perform public.upsert_herb('Gan Jiang','干姜','Zingiber officinale (Rhizoma exsiccatum)','Rhizoma Zingiberis','Dried ginger',
...
perform public.upsert_herb('Rou Gui','肉桂','Cinnamomum cassia (Cortex)','Cortex Cinnamomi','Cinnamon bark',
...
perform public.upsert_herb('Wu Zhu Yu','吴茱萸','Evodia rutaecarpa (Fructus)','Fructus Evodiae','Evodia fruit',
...
perform public.upsert_herb('Hua Jiao','花椒','Zanthoxylum bungeanum (Pericarpium)','Pericarpium Zanthoxyli','Sichuan pepper',
...
perform public.upsert_herb('Ding Xiang','丁香','Syzygium aromaticum (Flos)','Flos Caryophylli','Clove',
...
perform public.upsert_herb('Gao Liang Jiang','高良姜','Alpinia officinarum (Rhizoma)','Rhizoma Alpiniae Officinarum','Galangal',
...
perform public.upsert_herb('Xiao Hui Xiang','小茴香','Foeniculum vulgare (Fructus)','Fructus Foeniculi','Fennel fruit',
...
perform public.upsert_herb('Bi Ba','荜茇','Piper longum (Fructus)','Fructus Piperis Longi','Long pepper',
...
perform public.upsert_herb('Hu Jiao','胡椒','Piper nigrum (Fructus)','Fructus Piperis','Black pepper',
  'warm_interior','hot','{acrid}','{stomach,large_intestine}',
...
perform public.upsert_herb('Ren Shen','人参','Panax ginseng (Radix)','Radix Ginseng','Ginseng root',
...
perform public.upsert_herb('Xi Yang Shen','西洋参','Panax quinquefolius (Radix)','Radix Panacis Quinquefolii','American ginseng',
...
perform public.upsert_herb('Dang Shen','党参','Codonopsis pilosula (Radix)','Radix Codonopsis','Codonopsis root',
...
perform public.upsert_herb('Tai Zi Shen','太子参','Pseudostellaria heterophylla (Radix)','Radix Pseudostellariae','Prince ginseng',
...
perform public.upsert_herb('Huang Qi','黄芪','Astragalus membranaceus (Radix)','Radix Astragali','Astragalus root',
...
perform public.upsert_herb('Bai Zhu','白术','Atractylodes macrocephala (Rhizoma)','Rhizoma Atractylodis Macrocephalae','White atractylodes',
...
perform public.upsert_herb('Shan Yao','山药','Dioscorea opposita (Rhizoma)','Rhizoma Dioscoreae','Chinese yam',
...
perform public.upsert_herb('Gan Cao','甘草','Glycyrrhiza uralensis (Radix et Rhizoma)','Radix et Rhizoma Glycyrrhizae','Licorice root',
...
perform public.upsert_herb('Da Zao','大枣','Ziziphus jujuba (Fructus)','Fructus Jujubae','Jujube date',
...
perform public.upsert_herb('Huang Jing','黄精','Polygonatum sibiricum (Rhizoma)','Rhizoma Polygonati','Siberian Solomon''s seal',
  'tonify_qi','neutral','{sweet}','{spleen,lung,kidney}',
...
perform public.upsert_herb('Yi Tang','饴糖','Maltose (from grain)','Saccharum Granorum','Maltose, barley sugar',
...
perform public.upsert_herb('Feng Mi','蜂蜜','Apis mellifera (Mel)','Mel','Honey',
...
perform public.upsert_herb('Ci Wu Jia','刺五加','Eleutherococcus senticosus (Radix et Rhizoma)','Radix et Rhizoma Acanthopanacis Senticosi','Siberian ginseng, eleuthero',
...
perform public.upsert_herb('Hong Jing Tian','红景天','Rhodiola crenulata (Radix et Rhizoma)','Radix et Rhizoma Rhodiolae','Rhodiola',
...
perform public.upsert_herb('Jiao Gu Lan','绞股蓝','Gynostemma pentaphyllum (Herba)','Herba Gynostemmatis','Gynostemma, jiaogulan',
...
perform public.upsert_herb('Dang Gui','当归','Angelica sinensis (Radix)','Radix Angelicae Sinensis','Chinese angelica root',
...
perform public.upsert_herb('Shu Di Huang','熟地黄','Rehmannia glutinosa (Radix praeparata)','Radix Rehmanniae Praeparata','Prepared rehmannia root',
...
perform public.upsert_herb('Bai Shao','白芍','Paeonia lactiflora (Radix, prepared)','Radix Paeoniae Alba','White peony root',
...
perform public.upsert_herb('He Shou Wu','何首乌','Polygonum multiflorum (Radix, prepared)','Radix Polygoni Multiflori Praeparata','Fleeceflower root',
...
perform public.upsert_herb('E Jiao','阿胶','Equus asinus (Colla corii)','Colla Corii Asini','Donkey-hide gelatin',
...
perform public.upsert_herb('Long Yan Rou','龙眼肉','Dimocarpus longan (Arillus)','Arillus Longan','Longan fruit',
...
perform public.upsert_herb('Gou Qi Zi','枸杞子','Lycium barbarum (Fructus)','Fructus Lycii','Goji berry',
...
perform public.upsert_herb('Sang Shen','桑椹','Morus alba (Fructus)','Fructus Mori','Mulberry fruit',
...
perform public.upsert_herb('Lu Rong','鹿茸','Cervus nippon or C. elaphus (Cornu pantotrichum)','Cornu Cervi Pantotrichum','Deer velvet antler',
...
perform public.upsert_herb('Lu Jiao Jiao','鹿角胶','Cervus (Colla cornus)','Colla Cornus Cervi','Deer antler gelatin',
  'tonify_yang','warm','{sweet,salty}','{liver,kidney}',
...
perform public.upsert_herb('Rou Cong Rong','肉苁蓉','Cistanche deserticola (Herba)','Herba Cistanches','Cistanche',
...
perform public.upsert_herb('Ba Ji Tian','巴戟天','Morinda officinalis (Radix)','Radix Morindae Officinalis','Morinda root',
...
perform public.upsert_herb('Yin Yang Huo','淫羊藿','Epimedium brevicornu (Folium)','Herba Epimedii','Epimedium, horny goat weed',
...
perform public.upsert_herb('Xian Mao','仙茅','Curculigo orchioides (Rhizoma)','Rhizoma Curculiginis','Curculigo rhizome',
...
perform public.upsert_herb('Du Zhong','杜仲','Eucommia ulmoides (Cortex)','Cortex Eucommiae','Eucommia bark',
...
perform public.upsert_herb('Xu Duan','续断','Dipsacus asper (Radix)','Radix Dipsaci','Teasel root',
...
perform public.upsert_herb('Gu Sui Bu','骨碎补','Drynaria fortunei (Rhizoma)','Rhizoma Drynariae','Drynaria rhizome',
...
perform public.upsert_herb('Bu Gu Zhi','补骨脂','Psoralea corylifolia (Fructus)','Fructus Psoraleae','Psoralea fruit',
...
perform public.upsert_herb('Yi Zhi Ren','益智仁','Alpinia oxyphylla (Fructus)','Fructus Alpiniae Oxyphyllae','Bitter cardamom',
...
perform public.upsert_herb('Tu Si Zi','菟丝子','Cuscuta chinensis (Semen)','Semen Cuscutae','Dodder seed',
...
perform public.upsert_herb('Sha Yuan Zi','沙苑子','Astragalus complanatus (Semen)','Semen Astragali Complanati','Flatstem milkvetch seed',
  'tonify_yang','warm','{sweet}','{liver,kidney}',
...
perform public.upsert_herb('Suo Yang','锁阳','Cynomorium songaricum (Herba)','Herba Cynomorii','Cynomorium',
...
perform public.upsert_herb('Ge Jie','蛤蚧','Gekko gecko (whole body)','Gecko','Tokay gecko',
...
perform public.upsert_herb('Dong Chong Xia Cao','冬虫夏草','Ophiocordyceps sinensis (fungus on larva)','Cordyceps','Cordyceps',
...
perform public.upsert_herb('Hu Tao Ren','胡桃仁','Juglans regia (Semen)','Semen Juglandis','Walnut',
...
perform public.upsert_herb('Jiu Cai Zi','韭菜子','Allium tuberosum (Semen)','Semen Allii Tuberosi','Chinese chive seed',
  'tonify_yang','warm','{acrid,sweet}','{liver,kidney}',
...
perform public.upsert_herb('Bei Sha Shen','北沙参','Glehnia littoralis (Radix)','Radix Glehniae','Glehnia root',
...
perform public.upsert_herb('Nan Sha Shen','南沙参','Adenophora tetraphylla (Radix)','Radix Adenophorae','Adenophora root',
...
perform public.upsert_herb('Mai Men Dong','麦门冬','Ophiopogon japonicus (Radix)','Radix Ophiopogonis','Ophiopogon tuber',
...
perform public.upsert_herb('Tian Men Dong','天门冬','Asparagus cochinchinensis (Radix)','Radix Asparagi','Asparagus tuber',
...
perform public.upsert_herb('Shi Hu','石斛','Dendrobium nobile (Herba)','Herba Dendrobii','Dendrobium',
...
perform public.upsert_herb('Yu Zhu','玉竹','Polygonatum odoratum (Rhizoma)','Rhizoma Polygonati Odorati','Fragrant Solomon''s seal',
  'tonify_yin','slightly_cold','{sweet}','{lung,stomach}',
...
perform public.upsert_herb('Bai He','百合','Lilium brownii (Bulbus)','Bulbus Lilii','Lily bulb',
...
perform public.upsert_herb('Mo Han Lian','墨旱莲','Eclipta prostrata (Herba)','Herba Ecliptae','Eclipta',
...
perform public.upsert_herb('Nu Zhen Zi','女贞子','Ligustrum lucidum (Fructus)','Fructus Ligustri Lucidi','Glossy privet fruit',
...
perform public.upsert_herb('Gui Jia','龟甲','Chinemys reevesii (Plastrum)','Plastrum Testudinis','Tortoise plastron',
...
perform public.upsert_herb('Bie Jia','鳖甲','Trionyx sinensis (Carapax)','Carapax Trionycis','Soft-shelled turtle shell',
...
perform public.upsert_herb('Hei Zhi Ma','黑芝麻','Sesamum indicum (Semen nigrum)','Semen Sesami Nigrum','Black sesame seed',
...
perform public.upsert_herb('Yin Er','银耳','Tremella fuciformis (fruiting body)','Tremella','Silver ear fungus',

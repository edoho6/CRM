...
perform public.upsert_herb('Wu Wei Zi','五味子','Schisandra chinensis (Fructus)','Fructus Schisandrae','Schisandra berry',
...
perform public.upsert_herb('Wu Mei','乌梅','Prunus mume (Fructus)','Fructus Mume','Smoked plum',
...
perform public.upsert_herb('Shan Zhu Yu','山茱萸','Cornus officinalis (Fructus)','Fructus Corni','Asiatic cornelian cherry',
...
perform public.upsert_herb('Fu Pen Zi','覆盆子','Rubus chingii (Fructus)','Fructus Rubi','Chinese raspberry',
...
perform public.upsert_herb('Sang Piao Xiao','桑螵蛸','Tenodera sinensis (Ootheca)','Ootheca Mantidis','Mantis egg case',
...
perform public.upsert_herb('Jin Ying Zi','金樱子','Rosa laevigata (Fructus)','Fructus Rosae Laevigatae','Cherokee rose fruit',
...
perform public.upsert_herb('Qian Shi','芡实','Euryale ferox (Semen)','Semen Euryales','Euryale seed, fox nut',
...
perform public.upsert_herb('Lian Zi','莲子','Nelumbo nucifera (Semen)','Semen Nelumbinis','Lotus seed',
...
perform public.upsert_herb('Fu Xiao Mai','浮小麦','Triticum aestivum (Fructus levis)','Fructus Tritici Levis','Light wheat grain',
...
perform public.upsert_herb('Ma Huang Gen','麻黄根','Ephedra sinica (Radix)','Radix Ephedrae','Ephedra root',
...
perform public.upsert_herb('Rou Dou Kou','肉豆蔻','Myristica fragrans (Semen)','Semen Myristicae','Nutmeg',
...
perform public.upsert_herb('He Zi','诃子','Terminalia chebula (Fructus)','Fructus Chebulae','Chebulic myrobalan',
...
perform public.upsert_herb('Chi Shi Zhi','赤石脂','Halloysite (mineral)','Halloysitum Rubrum','Red halloysite clay',
...
perform public.upsert_herb('Yu Yu Liang','禹余粮','Limonite (mineral)','Limonitum','Limonite',
...
perform public.upsert_herb('Shi Liu Pi','石榴皮','Punica granatum (Pericarpium)','Pericarpium Granati','Pomegranate rind',
...
perform public.upsert_herb('Hai Piao Xiao','海螵蛸','Sepiella maindroni (Endoconcha)','Endoconcha Sepiae','Cuttlefish bone',
...
perform public.upsert_herb('Chun Pi','椿皮','Ailanthus altissima (Cortex)','Cortex Ailanthi','Tree of heaven bark',
...
perform public.upsert_herb('Long Gu','龙骨','Fossilized mammal bone','Os Draconis','Dragon bone (fossil)',
...
perform public.upsert_herb('Mu Li','牡蛎','Ostrea gigas (Concha)','Concha Ostreae','Oyster shell',
...
perform public.upsert_herb('Ci Shi','磁石','Magnetite (mineral, Fe3O4)','Magnetitum','Magnetite',
...
perform public.upsert_herb('Zhen Zhu','珍珠','Pteria martensii or Hyriopsis cumingii (Margarita)','Margarita','Pearl',
...
perform public.upsert_herb('Zhen Zhu Mu','珍珠母','Hyriopsis cumingii or Pteria (Concha usta)','Concha Margaritiferae Usta','Mother of pearl',
...
perform public.upsert_herb('Hu Po','琥珀','Fossil resin','Succinum','Amber',
...
perform public.upsert_herb('Zi Shi Ying','紫石英','Fluorite (mineral, CaF2)','Fluoritum','Fluorite',
...
perform public.upsert_herb('Suan Zao Ren','酸枣仁','Ziziphus jujuba var. spinosa (Semen)','Semen Ziziphi Spinosae','Sour jujube seed',
...
perform public.upsert_herb('Bai Zi Ren','柏子仁','Platycladus orientalis (Semen)','Semen Platycladi','Arborvitae seed',
...
perform public.upsert_herb('Yuan Zhi','远志','Polygala tenuifolia (Radix)','Radix Polygalae','Polygala root',
...
perform public.upsert_herb('He Huan Pi','合欢皮','Albizia julibrissin (Cortex)','Cortex Albiziae','Mimosa tree bark',
...
perform public.upsert_herb('He Huan Hua','合欢花','Albizia julibrissin (Flos)','Flos Albiziae','Mimosa tree flower',
  'calm_spirit_nourish','neutral','{sweet}','{heart,liver}',
...
perform public.upsert_herb('Ye Jiao Teng','夜交藤','Polygonum multiflorum (Caulis)','Caulis Polygoni Multiflori','Fleeceflower stem',
  'calm_spirit_nourish','neutral','{sweet}','{heart,liver}',
...
perform public.upsert_herb('Ling Zhi','灵芝','Ganoderma lucidum (fruiting body)','Ganoderma','Reishi mushroom',
...
perform public.upsert_herb('Fu Shen','茯神','Poria cocos (Sclerotium with pine root)','Poria cum Pini Radice','Poria with pine root',
...
perform public.upsert_herb('Lian Zi Xin','莲子心','Nelumbo nucifera (Plumula)','Plumula Nelumbinis','Lotus seed embryo',
...
perform public.upsert_herb('Bing Pian','冰片','Dryobalanops aromatica (Borneolum) or synthetic','Borneolum','Borneol',
...
perform public.upsert_herb('Shi Chang Pu','石菖蒲','Acorus tatarinowii (Rhizoma)','Rhizoma Acori Tatarinowii','Grassleaf sweetflag',
...
perform public.upsert_herb('Su He Xiang','苏合香','Liquidambar orientalis (Resina)','Styrax','Storax',
...
perform public.upsert_herb('An Xi Xiang','安息香','Styrax benzoin (Resina)','Benzoinum','Benzoin',
...
perform public.upsert_herb('Tian Ma','天麻','Gastrodia elata (Rhizoma)','Rhizoma Gastrodiae','Gastrodia rhizome',
...
perform public.upsert_herb('Gou Teng','钩藤','Uncaria rhynchophylla (Ramulus cum uncis)','Ramulus Uncariae cum Uncis','Gambir vine with hooks',
...
perform public.upsert_herb('Shi Jue Ming','石决明','Haliotis diversicolor (Concha)','Concha Haliotidis','Abalone shell',
...
perform public.upsert_herb('Dai Zhe Shi','代赭石','Hematite (mineral, Fe2O3)','Haematitum','Hematite',
...
perform public.upsert_herb('Jiang Can','僵蚕','Bombyx mori infected with Beauveria (larva)','Bombyx Batryticatus','Silkworm larva',
...
perform public.upsert_herb('Quan Xie','全蝎','Buthus martensii (whole body)','Scorpio','Scorpion',
...
perform public.upsert_herb('Wu Gong','蜈蚣','Scolopendra subspinipes (whole body)','Scolopendra','Centipede',
...
perform public.upsert_herb('Di Long','地龙','Pheretima aspergillum (whole body)','Pheretima','Earthworm',
...
perform public.upsert_herb('Ci Ji Li','刺蒺藜','Tribulus terrestris (Fructus)','Fructus Tribuli','Tribulus fruit',
...
perform public.upsert_herb('Luo Bu Ma','罗布麻','Apocynum venetum (Folium)','Folium Apocyni Veneti','Dogbane leaf',
...
perform public.upsert_herb('Niu Huang','牛黄','Bos taurus (Calculus)','Calculus Bovis','Ox gallstone, bezoar',
...
perform public.upsert_herb('Shan Yang Jiao','山羊角','Capra hircus (Cornu)','Cornu Caprae','Goat horn',
  'extinguish_wind','cold','{salty}','{liver}',
...
perform public.upsert_herb('Shi Jun Zi','使君子','Quisqualis indica (Fructus)','Fructus Quisqualis','Rangoon creeper fruit',
...
perform public.upsert_herb('Bing Lang','槟榔','Areca catechu (Semen)','Semen Arecae','Betel nut',
...
perform public.upsert_herb('Nan Gua Zi','南瓜子','Cucurbita moschata (Semen)','Semen Cucurbitae','Pumpkin seed',
...
perform public.upsert_herb('Ku Lian Pi','苦楝皮','Melia azedarach (Cortex)','Cortex Meliae','Chinaberry bark',
...
perform public.upsert_herb('Guan Zhong','贯众','Dryopteris crassirhizoma (Rhizoma)','Rhizoma Dryopteridis Crassirhizomatis','Male fern rhizome',
...
perform public.upsert_herb('Lei Wan','雷丸','Omphalia lapidescens (Sclerotium)','Omphalia','Omphalia',
...
perform public.upsert_herb('Fei Zi','榧子','Torreya grandis (Semen)','Semen Torreyae','Torreya nut',
...
perform public.upsert_herb('Da Suan','大蒜','Allium sativum (Bulbus)','Bulbus Allii Sativi','Garlic',
...
perform public.upsert_herb('Liu Huang','硫黄','Sulfur (mineral)','Sulfur','Sulfur',
...
perform public.upsert_herb('Ming Fan','明矾','Alum (mineral, potassium aluminium sulfate)','Alumen','Alum',
...
perform public.upsert_herb('Er Cha','儿茶','Acacia catechu (extract)','Catechu','Catechu',
...
perform public.upsert_herb('Peng Sha','硼砂','Borax (mineral)','Borax','Borax',
...
perform public.upsert_herb('Lu Gan Shi','炉甘石','Smithsonite (mineral, ZnCO3)','Calamina','Calamine',
...
perform public.upsert_herb('She Chuang Zi','蛇床子','Cnidium monnieri (Fructus)','Fructus Cnidii','Cnidium fruit',
...
perform public.upsert_herb('Mu Bie Zi','木鳖子','Momordica cochinchinensis (Semen)','Semen Momordicae','Cochinchin gourd seed',
...
perform public.upsert_herb('Zhang Nao','樟脑','Cinnamomum camphora (crystallised oil)','Camphora','Camphor',
...
perform public.upsert_herb('Song Xiang','松香','Pinus (Resina)','Colophonium','Rosin',
...
perform public.upsert_herb('Xue Jie','血竭','Daemonorops draco (Resina)','Sanguis Draconis','Dragon''s blood resin',

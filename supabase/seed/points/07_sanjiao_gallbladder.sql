...
perform public.catalogue_set_point_clinical('SJ1',
...
perform public.catalogue_set_point_clinical('SJ2',
...
perform public.catalogue_set_point_clinical('SJ3',
...
perform public.catalogue_set_point_clinical('SJ4',
...
perform public.catalogue_set_point_clinical('SJ5',
...
perform public.catalogue_set_point_clinical('SJ6',
...
perform public.catalogue_set_point_clinical('SJ7',
...
perform public.catalogue_set_point_clinical('SJ8',
...
perform public.catalogue_set_point_clinical('SJ9',
...
perform public.catalogue_set_point_clinical('SJ10',
...
perform public.catalogue_set_point_clinical('SJ11',
...
perform public.catalogue_set_point_clinical('SJ12',
...
perform public.catalogue_set_point_clinical('SJ13',
...
perform public.catalogue_set_point_clinical('SJ14',
...
perform public.catalogue_set_point_clinical('SJ15',
...
perform public.catalogue_set_point_clinical('SJ16',
...
perform public.catalogue_set_point_clinical('SJ17',
...
perform public.catalogue_set_point_clinical('SJ18',
...
perform public.catalogue_set_point_clinical('SJ19',
...
perform public.catalogue_set_point_clinical('SJ20',
...
perform public.catalogue_set_point_clinical('SJ21',
...
perform public.catalogue_set_point_clinical('SJ22',
...
perform public.catalogue_set_point_clinical('SJ23',
...
perform public.catalogue_set_point_clinical('GB1',
...
perform public.catalogue_set_point_clinical('GB2',
...
perform public.catalogue_set_point_clinical('GB3',
...
perform public.catalogue_set_point_clinical('GB4',
...
perform public.catalogue_set_point_clinical('GB5',
...
perform public.catalogue_set_point_clinical('GB6',
...
perform public.catalogue_set_point_clinical('GB7',
...
perform public.catalogue_set_point_clinical('GB8',
...
perform public.catalogue_set_point_clinical('GB9',
...
perform public.catalogue_set_point_clinical('GB10',
...
perform public.catalogue_set_point_clinical('GB11',
...
perform public.catalogue_set_point_clinical('GB12',
...
perform public.catalogue_set_point_clinical('GB13',
...
perform public.catalogue_set_point_clinical('GB14',
...
perform public.catalogue_set_point_clinical('GB15',
...
perform public.catalogue_set_point_clinical('GB16',
...
perform public.catalogue_set_point_clinical('GB17',
...
perform public.catalogue_set_point_clinical('GB18',
...
perform public.catalogue_set_point_clinical('GB19',
...
perform public.catalogue_set_point_clinical('GB20',
...
perform public.catalogue_set_point_clinical('GB21',
...
perform public.catalogue_set_point_clinical('GB22',
...
perform public.catalogue_set_point_clinical('GB23',
...
perform public.catalogue_set_point_clinical('GB24',
...
perform public.catalogue_set_point_clinical('GB25',
...
perform public.catalogue_set_point_clinical('GB26',
...
perform public.catalogue_set_point_clinical('GB27',
...
perform public.catalogue_set_point_clinical('GB28',
...
perform public.catalogue_set_point_clinical('GB29',
...
perform public.catalogue_set_point_clinical('GB30',
...
perform public.catalogue_set_point_clinical('GB31',
...
perform public.catalogue_set_point_clinical('GB32',
...
perform public.catalogue_set_point_clinical('GB33',
...
perform public.catalogue_set_point_clinical('GB34',
...
perform public.catalogue_set_point_clinical('GB35',
...
perform public.catalogue_set_point_clinical('GB36',
...
perform public.catalogue_set_point_clinical('GB37',
...
perform public.catalogue_set_point_clinical('GB38',
...
perform public.catalogue_set_point_clinical('GB39',
...
perform public.catalogue_set_point_clinical('GB40',
...
perform public.catalogue_set_point_clinical('GB41',
...
perform public.catalogue_set_point_clinical('GB42',
...
perform public.catalogue_set_point_clinical('GB43',
...
perform public.catalogue_set_point_clinical('GB44',

...
perform public.catalogue_set_point_clinical('LR1',
...
perform public.catalogue_set_point_clinical('LR2',
...
perform public.catalogue_set_point_clinical('LR3',
...
perform public.catalogue_set_point_clinical('LR4',
...
perform public.catalogue_set_point_clinical('LR5',
...
perform public.catalogue_set_point_clinical('LR6',
...
perform public.catalogue_set_point_clinical('LR7',
...
perform public.catalogue_set_point_clinical('LR8',
...
perform public.catalogue_set_point_clinical('LR9',
...
perform public.catalogue_set_point_clinical('LR10',
...
perform public.catalogue_set_point_clinical('LR11',
...
perform public.catalogue_set_point_clinical('LR12',
...
perform public.catalogue_set_point_clinical('LR13',
...
perform public.catalogue_set_point_clinical('LR14',
...
perform public.catalogue_set_point_clinical('REN1',
...
perform public.catalogue_set_point_clinical('REN2',
...
perform public.catalogue_set_point_clinical('REN3',
...
perform public.catalogue_set_point_clinical('REN4',
...
perform public.catalogue_set_point_clinical('REN5',
...
perform public.catalogue_set_point_clinical('REN6',
...
perform public.catalogue_set_point_clinical('REN7',
...
perform public.catalogue_set_point_clinical('REN8',
...
perform public.catalogue_set_point_clinical('REN9',
...
perform public.catalogue_set_point_clinical('REN10',
...
perform public.catalogue_set_point_clinical('REN11',
...
perform public.catalogue_set_point_clinical('REN12',
...
perform public.catalogue_set_point_clinical('REN13',
...
perform public.catalogue_set_point_clinical('REN14',
...
perform public.catalogue_set_point_clinical('REN15',
...
perform public.catalogue_set_point_clinical('REN16',
...
perform public.catalogue_set_point_clinical('REN17',
...
perform public.catalogue_set_point_clinical('REN18',
...
perform public.catalogue_set_point_clinical('REN19',
...
perform public.catalogue_set_point_clinical('REN20',
...
perform public.catalogue_set_point_clinical('REN21',
...
perform public.catalogue_set_point_clinical('REN22',
...
perform public.catalogue_set_point_clinical('REN23',
...
perform public.catalogue_set_point_clinical('REN24',
...
perform public.catalogue_set_point_clinical('DU1',
...
perform public.catalogue_set_point_clinical('DU2',
...
perform public.catalogue_set_point_clinical('DU3',
...
perform public.catalogue_set_point_clinical('DU4',
...
perform public.catalogue_set_point_clinical('DU5',
...
perform public.catalogue_set_point_clinical('DU6',
...
perform public.catalogue_set_point_clinical('DU7',
...
perform public.catalogue_set_point_clinical('DU8',
...
perform public.catalogue_set_point_clinical('DU9',
...
perform public.catalogue_set_point_clinical('DU10',
...
perform public.catalogue_set_point_clinical('DU11',
...
perform public.catalogue_set_point_clinical('DU12',
...
perform public.catalogue_set_point_clinical('DU13',
...
perform public.catalogue_set_point_clinical('DU14',
...
perform public.catalogue_set_point_clinical('DU15',
...
perform public.catalogue_set_point_clinical('DU16',
...
perform public.catalogue_set_point_clinical('DU17',
...
perform public.catalogue_set_point_clinical('DU18',
...
perform public.catalogue_set_point_clinical('DU19',
...
perform public.catalogue_set_point_clinical('DU20',
...
perform public.catalogue_set_point_clinical('DU21',
...
perform public.catalogue_set_point_clinical('DU22',
...
perform public.catalogue_set_point_clinical('DU23',
...
perform public.catalogue_set_point_clinical('DU24',
...
perform public.catalogue_set_point_clinical('DU25',
...
perform public.catalogue_set_point_clinical('DU26',
...
perform public.catalogue_set_point_clinical('DU27',
...
perform public.catalogue_set_point_clinical('DU28',

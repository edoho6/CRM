...
perform public.catalogue_set_point_clinical('BL1',
...
perform public.catalogue_set_point_clinical('BL2',
...
perform public.catalogue_set_point_clinical('BL3',
...
perform public.catalogue_set_point_clinical('BL4',
...
perform public.catalogue_set_point_clinical('BL5',
...
perform public.catalogue_set_point_clinical('BL6',
...
perform public.catalogue_set_point_clinical('BL7',
...
perform public.catalogue_set_point_clinical('BL8',
...
perform public.catalogue_set_point_clinical('BL9',
...
perform public.catalogue_set_point_clinical('BL10',
...
perform public.catalogue_set_point_clinical('BL11',
...
perform public.catalogue_set_point_clinical('BL12',
...
perform public.catalogue_set_point_clinical('BL13',
...
perform public.catalogue_set_point_clinical('BL14',
...
perform public.catalogue_set_point_clinical('BL15',
...
perform public.catalogue_set_point_clinical('BL16',
...
perform public.catalogue_set_point_clinical('BL17',
...
perform public.catalogue_set_point_clinical('BL18',
...
perform public.catalogue_set_point_clinical('BL19',
...
perform public.catalogue_set_point_clinical('BL20',
...
perform public.catalogue_set_point_clinical('BL21',
...
perform public.catalogue_set_point_clinical('BL22',
...
perform public.catalogue_set_point_clinical('BL23',
...
perform public.catalogue_set_point_clinical('BL24',
...
perform public.catalogue_set_point_clinical('BL25',
...
perform public.catalogue_set_point_clinical('BL26',
...
perform public.catalogue_set_point_clinical('BL27',
...
perform public.catalogue_set_point_clinical('BL28',
...
perform public.catalogue_set_point_clinical('BL29',
...
perform public.catalogue_set_point_clinical('BL30',
...
perform public.catalogue_set_point_clinical('BL31',
...
perform public.catalogue_set_point_clinical('BL32',
...
perform public.catalogue_set_point_clinical('BL33',
...
perform public.catalogue_set_point_clinical('BL34',
...
perform public.catalogue_set_point_clinical('BL35',
...
perform public.catalogue_set_point_clinical('BL36',
...
perform public.catalogue_set_point_clinical('BL37',
...
perform public.catalogue_set_point_clinical('BL38',
...
perform public.catalogue_set_point_clinical('BL39',
...
perform public.catalogue_set_point_clinical('BL40',
...
perform public.catalogue_set_point_clinical('BL41',
...
perform public.catalogue_set_point_clinical('BL42',
...
perform public.catalogue_set_point_clinical('BL43',
...
perform public.catalogue_set_point_clinical('BL44',
...
perform public.catalogue_set_point_clinical('BL45',
...
perform public.catalogue_set_point_clinical('BL46',
...
perform public.catalogue_set_point_clinical('BL47',
...
perform public.catalogue_set_point_clinical('BL48',
...
perform public.catalogue_set_point_clinical('BL49',
...
perform public.catalogue_set_point_clinical('BL50',
...
perform public.catalogue_set_point_clinical('BL51',
...
perform public.catalogue_set_point_clinical('BL52',
...
perform public.catalogue_set_point_clinical('BL53',
...
perform public.catalogue_set_point_clinical('BL54',
...
perform public.catalogue_set_point_clinical('BL55',
...
perform public.catalogue_set_point_clinical('BL56',
...
perform public.catalogue_set_point_clinical('BL57',
...
perform public.catalogue_set_point_clinical('BL58',
...
perform public.catalogue_set_point_clinical('BL59',
...
perform public.catalogue_set_point_clinical('BL60',
...
perform public.catalogue_set_point_clinical('BL61',
...
perform public.catalogue_set_point_clinical('BL62',
...
perform public.catalogue_set_point_clinical('BL63',
...
perform public.catalogue_set_point_clinical('BL64',
...
perform public.catalogue_set_point_clinical('BL65',
...
perform public.catalogue_set_point_clinical('BL66',
...
perform public.catalogue_set_point_clinical('BL67',

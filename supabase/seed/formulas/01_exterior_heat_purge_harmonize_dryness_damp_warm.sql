...
-- ============================================================================
-- Every call goes through public.catalogue_upsert_formula (migration 20260915200000)
-- into the shared catalogue; each clinic copies it with clinic_load_catalogue().
...
perform public.catalogue_upsert_formula('Ma Huang Tang','麻黄汤','Ephedra Decoction','release_exterior','Shang Han Lun (Zhang Zhong-Jing, c. 220)',
...
perform public.catalogue_upsert_formula('Gui Zhi Tang','桂枝汤','Cinnamon Twig Decoction','release_exterior','Shang Han Lun',
...
perform public.catalogue_upsert_formula('Xiao Qing Long Tang','小青龙汤','Minor Bluegreen Dragon Decoction','release_exterior','Shang Han Lun',
...
perform public.catalogue_upsert_formula('Jiu Wei Qiang Huo Tang','九味羌活汤','Nine-Herb Decoction with Notopterygium','release_exterior','Ci Shi Nan Zhi (Zhang Yuan-Su, 13th c.)',
...
perform public.catalogue_upsert_formula('Xiang Su San','香苏散','Cyperus and Perilla Leaf Powder','release_exterior','Tai Ping Hui Min He Ji Ju Fang (1107)',
...
perform public.catalogue_upsert_formula('Yin Qiao San','银翘散','Honeysuckle and Forsythia Powder','release_exterior','Wen Bing Tiao Bian (Wu Ju-Tong, 1798)',
...
perform public.catalogue_upsert_formula('Sang Ju Yin','桑菊饮','Mulberry Leaf and Chrysanthemum Drink','release_exterior','Wen Bing Tiao Bian',
...
perform public.catalogue_upsert_formula('Ma Xing Shi Gan Tang','麻杏石甘汤','Ephedra, Apricot Kernel, Gypsum and Licorice Decoction','release_exterior','Shang Han Lun',
...
perform public.catalogue_upsert_formula('Chai Ge Jie Ji Tang','柴葛解肌汤','Bupleurum and Kudzu Decoction to Release the Muscle Layer','release_exterior','Shang Han Liu Shu (Tao Hua, 1445)',
...
perform public.catalogue_upsert_formula('Sheng Ma Ge Gen Tang','升麻葛根汤','Cimicifuga and Kudzu Decoction','release_exterior','Tai Ping Hui Min He Ji Ju Fang',
...
perform public.catalogue_upsert_formula('Ren Shen Bai Du San','人参败毒散','Ginseng Powder to Overcome Pathogenic Influences','release_exterior','Tai Ping Hui Min He Ji Ju Fang',
...
perform public.catalogue_upsert_formula('Jia Jian Wei Rui Tang','加减葳蕤汤','Modified Solomon''s Seal Decoction','release_exterior','Chong Ding Tong Su Shang Han Lun (1916)',
...
perform public.catalogue_upsert_formula('Bai Hu Tang','白虎汤','White Tiger Decoction','clear_heat','Shang Han Lun',
...
perform public.catalogue_upsert_formula('Zhu Ye Shi Gao Tang','竹叶石膏汤','Lophatherum and Gypsum Decoction','clear_heat','Shang Han Lun',
...
perform public.catalogue_upsert_formula('Qing Ying Tang','清营汤','Clear the Nutritive Level Decoction','clear_heat','Wen Bing Tiao Bian',
...
perform public.catalogue_upsert_formula('Xi Jiao Di Huang Tang','犀角地黄汤','Rhinoceros Horn and Rehmannia Decoction (with water buffalo horn)','clear_heat','Bei Ji Qian Jin Yao Fang (Sun Si-Miao, 652)',
...
perform public.catalogue_upsert_formula('Huang Lian Jie Du Tang','黄连解毒汤','Coptis Decoction to Resolve Toxicity','clear_heat','Wai Tai Mi Yao (Wang Tao, 752)',
...
perform public.catalogue_upsert_formula('Liang Ge San','凉膈散','Cool the Diaphragm Powder','clear_heat','Tai Ping Hui Min He Ji Ju Fang',
...
perform public.catalogue_upsert_formula('Pu Ji Xiao Du Yin','普济消毒饮','Universal Benefit Drink to Eliminate Toxin','clear_heat','Dong Yuan Shi Xiao Fang (Li Dong-Yuan, 13th c.)',
...
perform public.catalogue_upsert_formula('Dao Chi San','导赤散','Guide Out the Red Powder','clear_heat','Xiao Er Yao Zheng Zhi Jue (Qian Yi, 1119)',
...
perform public.catalogue_upsert_formula('Long Dan Xie Gan Tang','龙胆泻肝汤','Gentian Decoction to Drain the Liver','clear_heat','Yi Fang Ji Jie (Wang Ang, 1682)',
...
perform public.catalogue_upsert_formula('Xie Bai San','泻白散','Drain the White Powder','clear_heat','Xiao Er Yao Zheng Zhi Jue',
...
perform public.catalogue_upsert_formula('Qing Wei San','清胃散','Clear the Stomach Powder','clear_heat','Pi Wei Lun (Li Dong-Yuan, 1249)',
...
perform public.catalogue_upsert_formula('Yu Nu Jian','玉女煎','Jade Woman Decoction','clear_heat','Jing Yue Quan Shu (Zhang Jing-Yue, 1624)',
...
perform public.catalogue_upsert_formula('Shao Yao Tang','芍药汤','Peony Decoction','clear_heat','Su Wen Bing Ji Qi Yi Bao Ming Ji (Liu Wan-Su, 1186)',
...
perform public.catalogue_upsert_formula('Bai Tou Weng Tang','白头翁汤','Pulsatilla Decoction','clear_heat','Shang Han Lun',
...
perform public.catalogue_upsert_formula('Qing Hao Bie Jia Tang','青蒿鳖甲汤','Artemisia Annua and Soft-Shelled Turtle Shell Decoction','clear_heat','Wen Bing Tiao Bian',
...
perform public.catalogue_upsert_formula('Qing Shu Yi Qi Tang','清暑益气汤','Clear Summerheat and Augment the Qi Decoction (Wang)','clear_heat','Wen Re Jing Wei (Wang Meng-Ying, 1852)',
...
perform public.catalogue_upsert_formula('Wu Wei Xiao Du Yin','五味消毒饮','Five-Ingredient Drink to Eliminate Toxin','clear_heat','Yi Zong Jin Jian (1742)',
...
perform public.catalogue_upsert_formula('Da Cheng Qi Tang','大承气汤','Major Order the Qi Decoction','purge','Shang Han Lun',
...
perform public.catalogue_upsert_formula('Xiao Cheng Qi Tang','小承气汤','Minor Order the Qi Decoction','purge','Shang Han Lun',
...
perform public.catalogue_upsert_formula('Tiao Wei Cheng Qi Tang','调胃承气汤','Regulate the Stomach and Order the Qi Decoction','purge','Shang Han Lun',
...
perform public.catalogue_upsert_formula('Ma Zi Ren Wan','麻子仁丸','Hemp Seed Pill','purge','Shang Han Lun',
...
perform public.catalogue_upsert_formula('Da Huang Fu Zi Tang','大黄附子汤','Rhubarb and Prepared Aconite Decoction','purge','Jin Gui Yao Lue',
...
perform public.catalogue_upsert_formula('Wen Pi Tang','温脾汤','Warm the Spleen Decoction','purge','Bei Ji Qian Jin Yao Fang',
...
perform public.catalogue_upsert_formula('Zeng Ye Cheng Qi Tang','增液承气汤','Increase the Fluids and Order the Qi Decoction','purge','Wen Bing Tiao Bian',
...
perform public.catalogue_upsert_formula('Xiao Chai Hu Tang','小柴胡汤','Minor Bupleurum Decoction','harmonize','Shang Han Lun',
...
perform public.catalogue_upsert_formula('Da Chai Hu Tang','大柴胡汤','Major Bupleurum Decoction','harmonize','Shang Han Lun',
...
perform public.catalogue_upsert_formula('Hao Qin Qing Dan Tang','蒿芩清胆汤','Artemisia Annua and Scutellaria Decoction to Clear the Gallbladder','harmonize','Chong Ding Tong Su Shang Han Lun',
...
perform public.catalogue_upsert_formula('Si Ni San','四逆散','Frigid Extremities Powder','harmonize','Shang Han Lun',
...
perform public.catalogue_upsert_formula('Xiao Yao San','逍遥散','Rambling Powder','harmonize','Tai Ping Hui Min He Ji Ju Fang',
...
perform public.catalogue_upsert_formula('Jia Wei Xiao Yao San','加味逍遥散','Augmented Rambling Powder','harmonize','Nei Ke Zhai Yao (Xue Ji, 16th c.)',
...
perform public.catalogue_upsert_formula('Tong Xie Yao Fang','痛泻要方','Important Formula for Painful Diarrhea','harmonize','Dan Xi Xin Fa (Zhu Dan-Xi, 1481)',
...
perform public.catalogue_upsert_formula('Ban Xia Xie Xin Tang','半夏泻心汤','Pinellia Decoction to Drain the Epigastrium','harmonize','Shang Han Lun',
...
perform public.catalogue_upsert_formula('Xing Su San','杏苏散','Apricot Kernel and Perilla Leaf Powder','treat_dryness','Wen Bing Tiao Bian',
...
perform public.catalogue_upsert_formula('Sang Xing Tang','桑杏汤','Mulberry Leaf and Apricot Kernel Decoction','treat_dryness','Wen Bing Tiao Bian',
...
perform public.catalogue_upsert_formula('Qing Zao Jiu Fei Tang','清燥救肺汤','Eliminate Dryness and Rescue the Lung Decoction','treat_dryness','Yi Men Fa Lu (Yu Chang, 1658)',
...
perform public.catalogue_upsert_formula('Mai Men Dong Tang','麦门冬汤','Ophiopogon Decoction','treat_dryness','Jin Gui Yao Lue',
...
perform public.catalogue_upsert_formula('Bai He Gu Jin Tang','百合固金汤','Lily Bulb Decoction to Preserve the Metal','treat_dryness','Shen Zhai Yi Shu (Zhou Zhi-Gan, 1573)',
...
perform public.catalogue_upsert_formula('Yang Yin Qing Fei Tang','养阴清肺汤','Nourish the Yin and Clear the Lung Decoction','treat_dryness','Chong Lou Yu Yao (Zheng Mei-Jian, 1838)',
...
perform public.catalogue_upsert_formula('Zeng Ye Tang','增液汤','Increase the Fluids Decoction','treat_dryness','Wen Bing Tiao Bian',
...
perform public.catalogue_upsert_formula('Ping Wei San','平胃散','Calm the Stomach Powder','expel_dampness','Tai Ping Hui Min He Ji Ju Fang',
...
perform public.catalogue_upsert_formula('Huo Xiang Zheng Qi San','藿香正气散','Agastache Powder to Rectify the Qi','expel_dampness','Tai Ping Hui Min He Ji Ju Fang',
...
perform public.catalogue_upsert_formula('Yin Chen Hao Tang','茵陈蒿汤','Virgate Wormwood Decoction','expel_dampness','Shang Han Lun',
...
perform public.catalogue_upsert_formula('San Ren Tang','三仁汤','Three-Seed Decoction','expel_dampness','Wen Bing Tiao Bian',
...
perform public.catalogue_upsert_formula('Gan Lu Xiao Du Dan','甘露消毒丹','Sweet Dew Special Pill to Eliminate Toxin','expel_dampness','Wen Re Jing Wei',
...
perform public.catalogue_upsert_formula('Ba Zheng San','八正散','Eight-Herb Powder for Rectification','expel_dampness','Tai Ping Hui Min He Ji Ju Fang',
...
perform public.catalogue_upsert_formula('Wu Ling San','五苓散','Five-Ingredient Powder with Poria','expel_dampness','Shang Han Lun',
...
perform public.catalogue_upsert_formula('Zhu Ling Tang','猪苓汤','Polyporus Decoction','expel_dampness','Shang Han Lun',
...
perform public.catalogue_upsert_formula('Fang Ji Huang Qi Tang','防己黄芪汤','Stephania and Astragalus Decoction','expel_dampness','Jin Gui Yao Lue',
...
perform public.catalogue_upsert_formula('Ling Gui Zhu Gan Tang','苓桂术甘汤','Poria, Cinnamon Twig, Atractylodes and Licorice Decoction','expel_dampness','Shang Han Lun',
...
perform public.catalogue_upsert_formula('Zhen Wu Tang','真武汤','True Warrior Decoction','expel_dampness','Shang Han Lun',
...
perform public.catalogue_upsert_formula('Shi Pi Yin','实脾饮','Bolster the Spleen Drink','expel_dampness','Chong Ding Yan Shi Ji Sheng Fang (Yan Yong-He, 1253)',
...
perform public.catalogue_upsert_formula('Qiang Huo Sheng Shi Tang','羌活胜湿汤','Notopterygium Decoction to Overcome Dampness','expel_dampness','Pi Wei Lun',
...
perform public.catalogue_upsert_formula('Du Huo Ji Sheng Tang','独活寄生汤','Angelica Pubescens and Taxillus Decoction','expel_dampness','Bei Ji Qian Jin Yao Fang',
...
perform public.catalogue_upsert_formula('Er Miao San','二妙散','Two-Marvel Powder','expel_dampness','Dan Xi Xin Fa',
...
perform public.catalogue_upsert_formula('Si Miao San','四妙散','Four-Marvel Powder','expel_dampness','Cheng Fang Bian Du (Zhang Bing-Cheng, 1904)',
...
perform public.catalogue_upsert_formula('Li Zhong Wan','理中丸','Regulate the Middle Pill','warm_interior','Shang Han Lun',
...
perform public.catalogue_upsert_formula('Xiao Jian Zhong Tang','小建中汤','Minor Construct the Middle Decoction','warm_interior','Shang Han Lun',
...
perform public.catalogue_upsert_formula('Wu Zhu Yu Tang','吴茱萸汤','Evodia Decoction','warm_interior','Shang Han Lun',
...
perform public.catalogue_upsert_formula('Da Jian Zhong Tang','大建中汤','Major Construct the Middle Decoction','warm_interior','Jin Gui Yao Lue',
...
perform public.catalogue_upsert_formula('Si Ni Tang','四逆汤','Frigid Extremities Decoction','warm_interior','Shang Han Lun',
...
perform public.catalogue_upsert_formula('Dang Gui Si Ni Tang','当归四逆汤','Tangkuei Decoction for Frigid Extremities','warm_interior','Shang Han Lun',
...
perform public.catalogue_upsert_formula('Yang He Tang','阳和汤','Yang-Heartening Decoction','warm_interior','Wai Ke Quan Sheng Ji (Wang Wei-De, 1740)',

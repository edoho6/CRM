...
perform public.catalogue_upsert_formula('Si Jun Zi Tang','四君子汤','Four-Gentlemen Decoction','tonify','Tai Ping Hui Min He Ji Ju Fang (1107)',
...
perform public.catalogue_upsert_formula('Liu Jun Zi Tang','六君子汤','Six-Gentlemen Decoction','tonify','Yi Xue Zheng Zhuan (Yu Tuan, 1515)',
...
perform public.catalogue_upsert_formula('Xiang Sha Liu Jun Zi Tang','香砂六君子汤','Six-Gentlemen Decoction with Aucklandia and Amomum','tonify','Gu Jin Ming Yi Fang Lun (Luo Mei, 1675)',
...
perform public.catalogue_upsert_formula('Shen Ling Bai Zhu San','参苓白术散','Ginseng, Poria and Atractylodes Powder','tonify','Tai Ping Hui Min He Ji Ju Fang',
...
perform public.catalogue_upsert_formula('Bu Zhong Yi Qi Tang','补中益气汤','Tonify the Middle and Augment the Qi Decoction','tonify','Pi Wei Lun (Li Dong-Yuan, 1249)',
...
perform public.catalogue_upsert_formula('Sheng Mai San','生脉散','Generate the Pulse Powder','tonify','Yi Xue Qi Yuan (Zhang Yuan-Su, 1186)',
...
perform public.catalogue_upsert_formula('Yu Ping Feng San','玉屏风散','Jade Windscreen Powder','tonify','Dan Xi Xin Fa (Zhu Dan-Xi, 1481)',
...
perform public.catalogue_upsert_formula('Si Wu Tang','四物汤','Four-Substance Decoction','tonify','Xian Shou Li Shang Xu Duan Mi Fang (Tang dynasty)',
...
perform public.catalogue_upsert_formula('Tao Hong Si Wu Tang','桃红四物汤','Four-Substance Decoction with Safflower and Peach Kernel','tonify','Yi Zong Jin Jian (1742)',
...
perform public.catalogue_upsert_formula('Dang Gui Bu Xue Tang','当归补血汤','Tangkuei Decoction to Tonify the Blood','tonify','Nei Wai Shang Bian Huo Lun (Li Dong-Yuan, 1247)',
...
perform public.catalogue_upsert_formula('Gui Pi Tang','归脾汤','Restore the Spleen Decoction','tonify','Ji Sheng Fang (Yan Yong-He, 1253)',
...
perform public.catalogue_upsert_formula('Ba Zhen Tang','八珍汤','Eight-Treasure Decoction','tonify','Zheng Ti Lei Yao (Xue Ji, 1529)',
...
perform public.catalogue_upsert_formula('Shi Quan Da Bu Tang','十全大补汤','All-Inclusive Great Tonifying Decoction','tonify','Tai Ping Hui Min He Ji Ju Fang',
...
perform public.catalogue_upsert_formula('Zhi Gan Cao Tang','炙甘草汤','Honey-Fried Licorice Decoction','tonify','Shang Han Lun',
...
perform public.catalogue_upsert_formula('Liu Wei Di Huang Wan','六味地黄丸','Six-Ingredient Pill with Rehmannia','tonify','Xiao Er Yao Zheng Zhi Jue (Qian Yi, 1119)',
...
perform public.catalogue_upsert_formula('Zhi Bai Di Huang Wan','知柏地黄丸','Anemarrhena, Phellodendron and Rehmannia Pill','tonify','Yi Zong Jin Jian',
...
perform public.catalogue_upsert_formula('Qi Ju Di Huang Wan','杞菊地黄丸','Lycium Fruit, Chrysanthemum and Rehmannia Pill','tonify','Yi Ji (Dong Xi-Yuan, 1777)',
...
perform public.catalogue_upsert_formula('Mai Wei Di Huang Wan','麦味地黄丸','Ophiopogon, Schisandra and Rehmannia Pill','tonify','Yi Ji',
...
perform public.catalogue_upsert_formula('Zuo Gui Wan','左归丸','Restore the Left (Kidney) Pill','tonify','Jing Yue Quan Shu (Zhang Jing-Yue, 1624)',
...
perform public.catalogue_upsert_formula('Da Bu Yin Wan','大补阴丸','Great Tonify the Yin Pill','tonify','Dan Xi Xin Fa',
...
perform public.catalogue_upsert_formula('Yi Guan Jian','一贯煎','Linking Decoction','tonify','Liu Zhou Yi Hua (Wei Zhi-Xiu, 1770)',
...
perform public.catalogue_upsert_formula('Er Zhi Wan','二至丸','Two-Solstice Pill','tonify','Yi Bian (1747)',
...
perform public.catalogue_upsert_formula('Jin Gui Shen Qi Wan','金匮肾气丸','Kidney Qi Pill from the Golden Cabinet','tonify','Jin Gui Yao Lue',
...
perform public.catalogue_upsert_formula('You Gui Wan','右归丸','Restore the Right (Kidney) Pill','tonify','Jing Yue Quan Shu',
...
perform public.catalogue_upsert_formula('Er Xian Tang','二仙汤','Two-Immortal Decoction','tonify','Shanghai (1950s, Zhang Bo-Na)',
...
perform public.catalogue_upsert_formula('Yue Ju Wan','越鞠丸','Escape Restraint Pill','regulate_qi','Dan Xi Xin Fa',
...
perform public.catalogue_upsert_formula('Chai Hu Shu Gan San','柴胡疏肝散','Bupleurum Powder to Spread the Liver','regulate_qi','Jing Yue Quan Shu',
...
perform public.catalogue_upsert_formula('Ban Xia Hou Po Tang','半夏厚朴汤','Pinellia and Magnolia Bark Decoction','regulate_qi','Jin Gui Yao Lue',
...
perform public.catalogue_upsert_formula('Gua Lou Xie Bai Bai Jiu Tang','栝楼薤白白酒汤','Trichosanthes, Chinese Garlic and Wine Decoction','regulate_qi','Jin Gui Yao Lue',
...
perform public.catalogue_upsert_formula('Tian Tai Wu Yao San','天台乌药散','Top-Quality Lindera Powder','regulate_qi','Yi Xue Fa Ming (Li Dong-Yuan, 13th c.)',
...
perform public.catalogue_upsert_formula('Su Zi Jiang Qi Tang','苏子降气汤','Perilla Fruit Decoction for Directing Qi Downward','regulate_qi','Tai Ping Hui Min He Ji Ju Fang',
...
perform public.catalogue_upsert_formula('Ding Chuan Tang','定喘汤','Arrest Wheezing Decoction','regulate_qi','She Sheng Zhong Miao Fang (Zhang Shi-Che, 1550)',
...
perform public.catalogue_upsert_formula('Xuan Fu Dai Zhe Tang','旋覆代赭汤','Inula and Hematite Decoction','regulate_qi','Shang Han Lun',
...
perform public.catalogue_upsert_formula('Ju Pi Zhu Ru Tang','橘皮竹茹汤','Tangerine Peel and Bamboo Shavings Decoction','regulate_qi','Jin Gui Yao Lue',
...
perform public.catalogue_upsert_formula('Ding Xiang Shi Di Tang','丁香柿蒂汤','Clove and Persimmon Calyx Decoction','regulate_qi','Zheng Yin Mai Zhi (Qin Jing-Ming, 1702)',
...
perform public.catalogue_upsert_formula('Xue Fu Zhu Yu Tang','血府逐瘀汤','Drive Out Stasis from the Mansion of Blood Decoction','invigorate_blood','Yi Lin Gai Cuo (Wang Qing-Ren, 1830)',
...
perform public.catalogue_upsert_formula('Bu Yang Huan Wu Tang','补阳还五汤','Tonify the Yang to Restore Five-Tenths Decoction','invigorate_blood','Yi Lin Gai Cuo',
...
perform public.catalogue_upsert_formula('Fu Yuan Huo Xue Tang','复元活血汤','Revive Health by Invigorating the Blood Decoction','invigorate_blood','Yi Xue Fa Ming',
...
perform public.catalogue_upsert_formula('Sheng Hua Tang','生化汤','Generation and Transformation Decoction','invigorate_blood','Fu Qing Zhu Nu Ke (Fu Shan, 1826)',
...
perform public.catalogue_upsert_formula('Wen Jing Tang','温经汤','Warm the Menses Decoction','invigorate_blood','Jin Gui Yao Lue',
...
perform public.catalogue_upsert_formula('Gui Zhi Fu Ling Wan','桂枝茯苓丸','Cinnamon Twig and Poria Pill','invigorate_blood','Jin Gui Yao Lue',
...
perform public.catalogue_upsert_formula('Shi Xiao San','失笑散','Sudden Smile Powder','invigorate_blood','Tai Ping Hui Min He Ji Ju Fang',
...
perform public.catalogue_upsert_formula('Dan Shen Yin','丹参饮','Salvia Drink','invigorate_blood','Shi Fang Ge Kuo (Chen Nian-Zu, 1801)',
...
perform public.catalogue_upsert_formula('Tao He Cheng Qi Tang','桃核承气汤','Peach Pit Decoction to Order the Qi','invigorate_blood','Shang Han Lun',
...
perform public.catalogue_upsert_formula('Shao Fu Zhu Yu Tang','少腹逐瘀汤','Drive Out Stasis from the Lower Abdomen Decoction','invigorate_blood','Yi Lin Gai Cuo',
...
perform public.catalogue_upsert_formula('Shen Tong Zhu Yu Tang','身痛逐瘀汤','Drive Out Stasis from a Painful Body Decoction','invigorate_blood','Yi Lin Gai Cuo',
...
perform public.catalogue_upsert_formula('Huo Luo Xiao Ling Dan','活络效灵丹','Fantastically Effective Pill to Invigorate the Collaterals','invigorate_blood','Yi Xue Zhong Zhong Can Xi Lu (Zhang Xi-Chun, 1918)',
...
perform public.catalogue_upsert_formula('Shi Hui San','十灰散','Ten Partially-Charred Substances Powder','stop_bleeding','Shi Yao Shen Shu (Ge Ke-Jiu, 1348)',
...
perform public.catalogue_upsert_formula('Ke Xue Fang','咳血方','Coughing of Blood Formula','stop_bleeding','Dan Xi Xin Fa',
...
perform public.catalogue_upsert_formula('Xiao Ji Yin Zi','小蓟饮子','Cephalanoplos Drink','stop_bleeding','Ji Sheng Fang',
...
perform public.catalogue_upsert_formula('Huai Hua San','槐花散','Sophora Japonica Flower Powder','stop_bleeding','Pu Ji Ben Shi Fang (Xu Shu-Wei, 1132)',
...
perform public.catalogue_upsert_formula('Huang Tu Tang','黄土汤','Yellow Earth Decoction','stop_bleeding','Jin Gui Yao Lue',
...
perform public.catalogue_upsert_formula('Jiao Ai Tang','胶艾汤','Ass-Hide Gelatin and Mugwort Decoction','stop_bleeding','Jin Gui Yao Lue',
...
perform public.catalogue_upsert_formula('Mu Li San','牡蛎散','Oyster Shell Powder','stabilize_bind','Tai Ping Hui Min He Ji Ju Fang',
...
perform public.catalogue_upsert_formula('Jin Suo Gu Jing Wan','金锁固精丸','Metal Lock Pill to Stabilize the Essence','stabilize_bind','Yi Fang Ji Jie (Wang Ang, 1682)',
...
perform public.catalogue_upsert_formula('Sang Piao Xiao San','桑螵蛸散','Mantis Egg-Case Powder','stabilize_bind','Ben Cao Yan Yi (Kou Zong-Shi, 1116)',
...
perform public.catalogue_upsert_formula('Suo Quan Wan','缩泉丸','Restrict the Fountain Pill','stabilize_bind','Fu Ren Liang Fang (Chen Zi-Ming, 1237)',
...
perform public.catalogue_upsert_formula('Si Shen Wan','四神丸','Four-Miracle Pill','stabilize_bind','Nei Ke Zhai Yao (Xue Ji, 16th c.)',
...
perform public.catalogue_upsert_formula('Zhen Ren Yang Zang Tang','真人养脏汤','True Man''s Decoction to Nourish the Organs','stabilize_bind','Tai Ping Hui Min He Ji Ju Fang',
...
perform public.catalogue_upsert_formula('Gu Chong Tang','固冲汤','Stabilize Gushing Decoction','stabilize_bind','Yi Xue Zhong Zhong Can Xi Lu',
...
perform public.catalogue_upsert_formula('Wan Dai Tang','完带汤','End Discharge Decoction','stabilize_bind','Fu Qing Zhu Nu Ke',
...
perform public.catalogue_upsert_formula('Yi Huang Tang','易黄汤','Change Yellow Discharge Decoction','stabilize_bind','Fu Qing Zhu Nu Ke',
...
perform public.catalogue_upsert_formula('Suan Zao Ren Tang','酸枣仁汤','Sour Jujube Decoction','calm_spirit','Jin Gui Yao Lue',
...
perform public.catalogue_upsert_formula('Tian Wang Bu Xin Dan','天王补心丹','Emperor of Heaven''s Special Pill to Tonify the Heart','calm_spirit','She Sheng Mi Pou (Hong Ji, 1638)',
...
perform public.catalogue_upsert_formula('Gan Mai Da Zao Tang','甘麦大枣汤','Licorice, Wheat and Jujube Decoction','calm_spirit','Jin Gui Yao Lue',
...
perform public.catalogue_upsert_formula('Huang Lian E Jiao Tang','黄连阿胶汤','Coptis and Ass-Hide Gelatin Decoction','calm_spirit','Shang Han Lun',
...
perform public.catalogue_upsert_formula('Bai Zi Yang Xin Wan','柏子养心丸','Arborvitae Seed Pill to Nourish the Heart','calm_spirit','Ti Ren Hui Bian (Peng Yong-Guang, 1549)',
...
perform public.catalogue_upsert_formula('Chai Hu Jia Long Gu Mu Li Tang','柴胡加龙骨牡蛎汤','Bupleurum plus Dragon Bone and Oyster Shell Decoction','calm_spirit','Shang Han Lun',
...
perform public.catalogue_upsert_formula('An Gong Niu Huang Wan','安宫牛黄丸','Calm the Palace Pill with Cattle Gallstone','open_orifices','Wen Bing Tiao Bian',
...
perform public.catalogue_upsert_formula('Su He Xiang Wan','苏合香丸','Storax Pill','open_orifices','Tai Ping Hui Min He Ji Ju Fang',
...
perform public.catalogue_upsert_formula('Chuan Xiong Cha Tiao San','川芎茶调散','Ligusticum Powder to be Taken with Green Tea','extinguish_wind','Tai Ping Hui Min He Ji Ju Fang',
...
perform public.catalogue_upsert_formula('Xiao Feng San','消风散','Eliminate Wind Powder','extinguish_wind','Wai Ke Zheng Zong (Chen Shi-Gong, 1617)',
...
perform public.catalogue_upsert_formula('Qian Zheng San','牵正散','Lead to Symmetry Powder','extinguish_wind','Yang Shi Jia Cang Fang (Yang Tan, 1178)',
...
perform public.catalogue_upsert_formula('Tian Ma Gou Teng Yin','天麻钩藤饮','Gastrodia and Uncaria Drink','extinguish_wind','Za Bing Zheng Zhi Xin Yi (Hu Guang-Ci, 1958)',
...
perform public.catalogue_upsert_formula('Zhen Gan Xi Feng Tang','镇肝熄风汤','Sedate the Liver and Extinguish Wind Decoction','extinguish_wind','Yi Xue Zhong Zhong Can Xi Lu',
...
perform public.catalogue_upsert_formula('Ling Jiao Gou Teng Tang','羚角钩藤汤','Antelope Horn and Uncaria Decoction (with goat horn)','extinguish_wind','Tong Su Shang Han Lun (Yu Gen-Chu, 1776)',
...
perform public.catalogue_upsert_formula('Da Ding Feng Zhu','大定风珠','Major Arrest Wind Pearl','extinguish_wind','Wen Bing Tiao Bian',
...
perform public.catalogue_upsert_formula('Zhi Jing San','止痉散','Stop Spasms Powder','extinguish_wind','Fang Ji Xue (modern)',
...
perform public.catalogue_upsert_formula('Er Chen Tang','二陈汤','Two-Aged Decoction','treat_phlegm','Tai Ping Hui Min He Ji Ju Fang',
...
perform public.catalogue_upsert_formula('Wen Dan Tang','温胆汤','Warm the Gallbladder Decoction','treat_phlegm','San Yin Ji Yi Bing Zheng Fang Lun (Chen Yan, 1174)',
...
perform public.catalogue_upsert_formula('Qing Qi Hua Tan Wan','清气化痰丸','Clear the Qi and Transform Phlegm Pill','treat_phlegm','Yi Fang Kao (Wu Kun, 1584)',
...
perform public.catalogue_upsert_formula('Bei Mu Gua Lou San','贝母瓜蒌散','Fritillaria and Trichosanthes Fruit Powder','treat_phlegm','Yi Xue Xin Wu (Cheng Guo-Peng, 1732)',
...
perform public.catalogue_upsert_formula('Ban Xia Bai Zhu Tian Ma Tang','半夏白术天麻汤','Pinellia, Atractylodes and Gastrodia Decoction','treat_phlegm','Yi Xue Xin Wu',
...
perform public.catalogue_upsert_formula('Ling Gan Wu Wei Jiang Xin Tang','苓甘五味姜辛汤','Poria, Licorice, Schisandra, Ginger and Asarum Decoction','treat_phlegm','Jin Gui Yao Lue',
...
perform public.catalogue_upsert_formula('San Zi Yang Qin Tang','三子养亲汤','Three-Seed Decoction to Nourish One''s Parents','treat_phlegm','Han Shi Yi Tong (Han Mao, 1522)',
...
perform public.catalogue_upsert_formula('Zhi Sou San','止嗽散','Stop Coughing Powder','treat_phlegm','Yi Xue Xin Wu',
...
perform public.catalogue_upsert_formula('Xiao Luo Wan','消瘰丸','Reduce Scrofula Pill','treat_phlegm','Yi Xue Zhong Zhong Can Xi Lu',
...
perform public.catalogue_upsert_formula('Hai Zao Yu Hu Tang','海藻玉壶汤','Sargassum Decoction for the Jade Flask','treat_phlegm','Wai Ke Zheng Zong',
...
perform public.catalogue_upsert_formula('Gun Tan Wan','滚痰丸','Vaporize Phlegm Pill','treat_phlegm','Yu Ji Wei Yi (Wang Yin-Jun, Yuan dynasty)',
...
perform public.catalogue_upsert_formula('Ding Xian Wan','定痫丸','Arrest Seizures Pill','treat_phlegm','Yi Xue Xin Wu',
...
perform public.catalogue_upsert_formula('Bao He Wan','保和丸','Preserve Harmony Pill','reduce_food_stagnation','Dan Xi Xin Fa',
...
perform public.catalogue_upsert_formula('Zhi Shi Dao Zhi Wan','枳实导滞丸','Unripe Bitter Orange Pill to Guide Out Stagnation','reduce_food_stagnation','Nei Wai Shang Bian Huo Lun',
...
perform public.catalogue_upsert_formula('Jian Pi Wan','健脾丸','Strengthen the Spleen Pill','reduce_food_stagnation','Zheng Zhi Zhun Sheng (Wang Ken-Tang, 1602)',
...
perform public.catalogue_upsert_formula('Mu Xiang Bing Lang Wan','木香槟榔丸','Aucklandia and Betel Nut Pill','reduce_food_stagnation','Ru Men Shi Qin (Zhang Cong-Zheng, 1228)',
...
perform public.catalogue_upsert_formula('Wu Mei Wan','乌梅丸','Mume Pill','expel_parasites','Shang Han Lun',
...
perform public.catalogue_upsert_formula('Fei Er Wan','肥儿丸','Fat Baby Pill','expel_parasites','Yi Zong Jin Jian',
